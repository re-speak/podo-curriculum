...
- Tutor action: Introduce today’s topic, ask the learner to read “Something you've been putting off” once, and move on.
- Visible target or prompt: Let's understand one delayed task and make the next action clear. Please read the title aloud. 先延ばしにしていることを理解し、次の行動を明確にしましょう。タイトルを声に出して読んでください。
- Learning target: Orient the learner to a conversation about “Something you've been putting off” without previewing or drilling answers.
- Pedagogical value: Sets the specific discussion can-do for “Something you've been putting off” and gives one immediate low-pressure speaking action.
...
- Visible target or prompt: Why we keep delaying things (先延ばしを続ける理由): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the optional pre-study article about “Something you've been putting off” to seed concrete ideas and topic vocabulary.
- Pedagogical value: Ten or more linked claims give the learner possible angles for the later “Something you've been putting off” conversation without prescribing an answer.
...
- Non-target support: The accessible article uses shorter, more direct clauses, aligned Japanese for every claim, and these selective glosses: put off 先延ばしにする.
...
- Tutor action: Honor the learner’s selected correction timing while discussing “Something you've been putting off.”
...
- Learner action: Listen to how the eight-question pool for “Something you've been putting off” will be used, then begin the conversation.
...
- Learning target: Frame “Something you've been putting off” as reciprocal conversation rather than eight questions to complete in order.
...
- Tutor action: React or share briefly, then use “Who else might have a problem?” or another relevant probe rather than asking every printed follow-up.
...
- Pedagogical value: The answerable main prompt “What can happen when a task never gets done?” opens this angle; “Who else might have a problem?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “Who else might have a problem?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
...
- Choice/distractor quality: There are no artificial distractors or forced frames; “When might it be better to stop?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
...
- Learner action: Answer “If you finish something late, how do you usually feel?” aloud, then develop whichever detail becomes most interesting.
- Tutor action: React or share briefly, then use “Does the result match the worry?” or another relevant probe rather than asking every printed follow-up.
- Visible target or prompt: If you finish something late, how do you usually feel? 遅れて何かを終えたとき、普段どんな気持ちになりますか？
...
- Pedagogical value: The answerable main prompt “If you finish something late, how do you usually feel?” opens this angle; “Does the result match the worry?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “Does the result match the worry?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
- Article treatment: The prompt stands alone even if pre-study was skipped; article ideas may support the answer to “If you finish something late, how do you usually feel?” but are never required.
...
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["If you finish something late, how do you usually feel?"]}`
- Visual QA: 360px **pass**; 480px **pass**
- Verdict: **pass**
- Notes: Source-level semantic inspection is complete; root rendered this exact page at 360px and 480px with no overflow and completed the visual and human page audit.
...
- Learner action: Answer “If something gets delayed again, what could you do next?” aloud, then develop whichever detail becomes most interesting.
- Tutor action: React or share briefly, then use “What is a ten-minute next step?” or another relevant probe rather than asking every printed follow-up.
- Visible target or prompt: If something gets delayed again, what could you do next? また何かを先延ばしにしたら、次に何ができますか？
...
- Pedagogical value: The answerable main prompt “If something gets delayed again, what could you do next?” opens this angle; “What is a ten-minute next step?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “What is a ten-minute next step?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
- Article treatment: The prompt stands alone even if pre-study was skipped; article ideas may support the answer to “If something gets delayed again, what could you do next?” but are never required.
...
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["If something gets delayed again, what could you do next?"]}`
- Visual QA: 360px **pass**; 480px **pass**
- Verdict: **pass**
- Notes: Source-level semantic inspection is complete; root rendered this exact page at 360px and 480px with no overflow and completed the visual and human page audit.
...
- Tutor action: Summarize evidence from the “Something you've been putting off” discussion and ask the learner to repeat one useful correction.
