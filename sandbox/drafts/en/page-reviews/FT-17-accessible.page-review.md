...
- SHA-256: `a47d1cdc29a11ddd3f627a4fb09275b05c3ba4d94b92e3591c6fee0ebd82fc2e`
- Generated: **pass**
...
- Learner action: Answer “Does praise make you want to keep going?” aloud, then develop whichever detail becomes most interesting.
...
- Visible target or prompt: Does praise make you want to keep going? 褒められると、続けたい気持ちになりますか？
...
- Pedagogical value: The answerable main prompt “Does praise make you want to keep going?” opens this angle; “Whose praise matters most?” can turn a first response into a more specific exchange.
...
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
- Article treatment: The prompt stands alone even if pre-study was skipped; article ideas may support the answer to “Does praise make you want to keep going?” but are never required.
- Choice/distractor quality: There are no artificial distractors or forced frames; “What helps when nobody praises you?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Does praise make you want to keep going?"]}`
- Visual QA: 360px **pass**; 480px **pass**
- Verdict: **pass**
- Notes: Source-level semantic inspection is complete; root rendered this exact page at 360px and 480px with no overflow and completed the visual and human page audit.
