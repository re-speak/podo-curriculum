...
- Learner action: Listen to the can-do, then read the exact lesson title “Your real bedtime” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “Your real bedtime” once, and move on.
- Visible target or prompt: Let's talk about what shapes your real bedtime and the rest you get. Please read the title aloud. 実際に眠る時間と、取れる休息を左右するものについて話しましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “Your real bedtime” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “Your real bedtime” and begins with a low-pressure title reading.
...
- Visible target or prompt: The gap before sleep (眠るまでのずれ): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “Your real bedtime.”
- Pedagogical value: The article moves from “The time we intend to sleep often differs from the moment sleep actually begins.” to “The meaningful goal is sustainable rest rather than a routine that merely appears disciplined.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective full glosses (stopping point (区切り), wind down (ゆっくり一日を終える)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this full article owns stopping point (区切り), wind down (ゆっくり一日を終える).
...
- Learner action: Listen to how the eight-question pool for “Your real bedtime” will be used, then begin the conversation.
...
- Learning target: Frame “Your real bedtime” as reciprocal conversation rather than eight questions to complete in order.
