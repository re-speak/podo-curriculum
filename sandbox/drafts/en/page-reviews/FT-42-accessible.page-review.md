...
- Pedagogical value: The article moves from “Every household develops rules that feel obvious inside it.” to “The rules people remember become part of a family's story.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective accessible glosses (household rule (家庭の決まり)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this accessible article owns household rule (家庭の決まり).
