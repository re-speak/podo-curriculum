...
- Visible target or prompt: Make a safety decision with incomplete information: Challenge a weak safety assumption and choose the lower-risk option. / 根拠の弱い安全判断を問い直し、よりリスクの低い選択をしましょう。
- Learning target: Orient the learner to the exact make a safety decision with incomplete information outcome before role-play.
...
- Tutor action: Play the tour operator and begin with the first counterpart line.
- Visible target or prompt: Calling about a remote excursion in severe weather; learner is Traveller, tutor is Tour Operator; first tutor line: “The excursion hasn't been cancelled, so it should be fine.”
...
- Component consistency: Uses the shared six-turn dialogue component with stable Traveller/Tour Operator roles.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Tutor-owned Tour Operator lines: “It hasn't been cancelled, so it should be fine.”; “The latest advisory warns of flash flooding.”; “I can move your booking to Saturday without a fee.”; “We'll check the advisory again on Friday.”
...
- Visible target or prompt: err on the side of caution (安全側に判断する); weather advisory (気象注意報)
...
- Extracted evidence: `{"targetHighlights": ["The fact that", "doesn't necessarily mean", "という事実だけでは", "必ずしもなりません", "The fact that", "doesn't necessarily mean", "という事実だけでは", "必ずしもなりません", "The fact that", "doesn't necessarily mean", "という事実だけでは", "必ずしもなりません"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["The fact that", "doesn't necessarily mean", "という事実だけでは", "必ずしもなりません", "The fact that", "doesn't necessarily mean", "という事実だけでは", "必ずしもなりません", "The fact that", "doesn't necessarily mean", "という事実だけでは", "必ずしもなりません", "The fact that", "doesn't necessarily mean", "という事実だけでは", "必ずしもなりません"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["という事実だけでは", "必ずしもなりません", "という事実だけでは", "必ずしもなりません", "という事実だけでは", "必ずしもなりません", "という事実だけでは", "必ずしもなりません"], "blankAnswers": ["The fact that", "doesn't necessarily mean", "The fact that", "doesn't necessarily mean", "The fact that", "doesn't necessarily mean", "The fact that", "doesn't necessarily mean"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["The fact that it hasn't been cancelled doesn't necessarily mean it's safe.", "The fact that the road is open doesn't necessarily mean it's safe.", "The fact that others are going doesn't necessarily mean it's safe.", "The fact that the warning is old doesn't necessarily mean it's safe."], "hintChips": ["中止されていない:it hasn't been cancelled", "道路が開いている:the road is open", "ほかの人が行く:others are going", "警告が古い:the warning is old"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “The fact that ___ doesn't necessarily mean ___” to challenge one weak safety assumption."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: The examples vary meaningful content rather than presenting a selection task.
- Component consistency: Uses the shared meaning-and-use teaching component with one example block.
- Extracted evidence: `{"targetHighlights": ["Overall, I'd rather", "than take the risk", "総合的に考えると、私が望むのは", "危険を冒すことではありません", "Overall, I'd rather", "than take the risk", "総合的に考えると、私が望むのは", "危険を冒すことではありません", "Overall, I'd rather", "than take the risk", "総合的に考えると、私が望むのは", "危険を冒すことではありません"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No choices are used; each blank has one answer established by its complete sentence.
- Component consistency: Uses the shared static synchronized target-blank input component.
- Extracted evidence: `{"targetHighlights": ["総合的に考えると、私が望むのは", "危険を冒すことではありません", "総合的に考えると、私が望むのは", "危険を冒すことではありません", "総合的に考えると、私が望むのは", "危険を冒すことではありません", "総合的に考えると、私が望むのは", "危険を冒すことではありません"], "blankAnswers": ["Overall, I'd rather", "than take the risk", "Overall, I'd rather", "than take the risk", "Overall, I'd rather", "than take the risk", "Overall, I'd rather", "than take the risk"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; each Japanese cue maps to one practised complete sentence.
- Component consistency: Uses the target-v2 shared full-sentence input with an explicit support stage.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["Overall, I'd rather postpone than take the risk.", "Overall, I'd rather turn back than take the risk.", "Overall, I'd rather wait than take the risk.", "Overall, I'd rather cancel than take the risk."], "hintChips": ["延期する:postpone", "引き返す:turn back", "待つ:wait", "中止する:cancel"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: Open production has no fixed choices; the stable frame bounds acceptable answers.
- Component consistency: Uses the shared student-sentence/correction feedback component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “Overall, I'd rather ___ than take the risk” to state the safer action you choose."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["The fact that", "doesn't necessarily mean", "という事実だけでは", "必ずしもなりません", "Overall, I'd rather", "than take the risk", "総合的に考えると、私が望むのは", "危険を冒すことではありません"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["The fact that", "doesn't necessarily mean", "Overall, I'd rather", "than take the risk"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["When weather changes a trip, are you more likely to postpone it or change the plan?", "What about you—what would you usually do?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Use “advisory” below “warning” / warning より弱い advisory; contrast: a weather advisory versus a weather warning
