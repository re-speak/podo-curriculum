...
- Learner action: Listen to the can-do, then read the exact lesson title “What you really do when you're stressed” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “What you really do when you're stressed” once, and move on.
- Visible target or prompt: Let's compare what you really do with what you wish you did. Please read the title aloud. ストレスがあるとき実際にすることと、理想の対処を比べましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “What you really do when you're stressed” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “What you really do when you're stressed” and begins with a low-pressure title reading.
...
- Visible target or prompt: Our real stress habits (本当のストレス習慣): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “What you really do when you're stressed.”
- Pedagogical value: The article moves from “Advice about stress is usually much easier to offer than to apply under pressure.” to “Improvement may mean recognizing the pattern sooner rather than eliminating it forever.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective full glosses (coping response (ストレスへの対処), procrastinate (先延ばしにする)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this full article owns coping response (ストレスへの対処), procrastinate (先延ばしにする).
...
- Learner action: Listen to how the eight-question pool for “What you really do when you're stressed” will be used, then begin the conversation.
...
- Learning target: Frame “What you really do when you're stressed” as reciprocal conversation rather than eight questions to complete in order.
...
- Learner action: Respond aloud to “How accurately do people describe their own coping responses under stress?” and develop the most interesting concrete detail.
...
- Visible target or prompt: How accurately do people describe their own coping responses under stress? 人は、ストレスがあるときにすることを、普段どのくらい正直に話すでしょうか？
...
- Non-target support: The main prompt has direct Japanese support; the two distinct English follow-ups remain tutor-only and do not crowd the learner page.
- Article treatment: This prompt stands alone if pre-study was skipped; the article may seed ideas for “How accurately do people describe their own coping responses under stress?” but is never required.
...
- Component consistency: Matches the approved Freetalking prompt component: one bilingual talking job, two tutor-only probes, and a Student's sentence feedback box.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["How accurately do people describe their own coping responses under stress?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
- Notes: Main prompt, Japanese support, and every follow-up job were reviewed semantically in source; root visual inspection remains pending.
...
- Learner action: Respond aloud to “What signal could help you recognize stress sooner?” and develop the most interesting concrete detail.
...
- Visible target or prompt: What signal could help you recognize stress sooner? どのようなサインがあれば、もっと早くストレスに気づけますか？
...
- Non-target support: The main prompt has direct Japanese support; the two distinct English follow-ups remain tutor-only and do not crowd the learner page.
- Article treatment: This prompt stands alone if pre-study was skipped; the article may seed ideas for “What signal could help you recognize stress sooner?” but is never required.
...
- Component consistency: Matches the approved Freetalking prompt component: one bilingual talking job, two tutor-only probes, and a Student's sentence feedback box.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What signal could help you recognize stress sooner?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
- Notes: Main prompt, Japanese support, and every follow-up job were reviewed semantically in source; root visual inspection remains pending.
