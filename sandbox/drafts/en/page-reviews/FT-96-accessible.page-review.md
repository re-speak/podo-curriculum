...
- Learning target: Use ten matched claims, from “In this scenario, AI handles routine tasks while resources remain stable.” to “The question separates what we do from why it matters.,” as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned accessible-specific Japanese claims are available; this variant owns these selective glosses: work identity=仕事を通じた自己認識.
