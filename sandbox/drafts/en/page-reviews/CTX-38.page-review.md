...
- Visible target or prompt: Clarify who owns an action: Identify the action owner and keep the task from being missed. / 担当者を確認し、仕事が抜け落ちないようにしましょう。
- Learning target: Orient the learner to the exact clarify who owns an action outcome before role-play.
...
- Visible target or prompt: A supplier task with no clear owner; learner is Colleague, tutor is Project Lead; first tutor line: “Your team thinks ours is contacting the supplier, but our team thinks yours is.”
...
- Visible target or prompt: Tutor-owned Project Lead lines: “Your team thinks ours is contacting the supplier, but our team thinks yours is.”; “I thought your team was doing it.”; “No one has taken that action yet.”; “Thanks. Please copy me in.”
...
- Visible target or prompt: action owner (作業の担当者); copy me in (私も宛先に入れる)
...
- Non-target support: Row-specific lexical chips support non-target content: ['仕入先:supplier', '顧客:client', '請求書:invoice', '会議室:room'].
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["Just to clarify, who's contacting the supplier?", "Just to clarify, who's calling the client?", "Just to clarify, who's sending the invoice?", "Just to clarify, who's booking the room?"], "hintChips": ["仕入先:supplier", "顧客:client", "請求書:invoice", "会議室:room"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “Just to clarify, who's ___?” to ask who owns one unclear contact task."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["I'm happy to contact them if no one else is doing it.", "I'm happy to call them if no one else is doing it.", "I'm happy to send it if no one else is doing it.", "I'm happy to book it if no one else is doing it."], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; the learner chooses content within a stable pattern frame.
- Component consistency: Uses the shared Student’s sentence and Correction capture component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “I'm happy to ___ if no one else is doing it” to offer to take an unassigned task."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Return to a supplier task with no clear owner and complete both practical moves in one role-play.
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Which kind of work do you prefer to own: contacting people, planning, or checking details?", "What about you—which kind of work do you prefer?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Choose one message or ongoing updates / 一通か継続的な共有か: Use “copy me in” for one email; use “keep me posted” for continuing updates.
