...
- Learner action: Listen to the can-do, then read the exact title “Morning person or night owl?” aloud once.
- Tutor action: State the can-do, invite one title reading, then move directly to the optional article page.
- Visible target or prompt: Morning person or night owl? / 朝型、それとも夜型？. Let's compare a morning schedule and a night schedule, then explain what could change your choice. / 朝型の生活と夜型の生活を比べ、何が変われば選択も変わるか話しましょう。
- Learning target: Orient the learner to a balanced conversation about Morning person or night owl? without supplying a preferred answer.
...
- Non-target support: The Japanese can-do “朝型の生活と夜型の生活を比べ、何が変われば選択も変わるか話しましょう。” and title “朝型、それとも夜型？” match the English topic and action.
...
- Learning target: Use ten topic-specific claims, from “Light exposure is one of the strongest signals that shifts circadian timing.” to “The workable answer balances biological preference with fixed commitments and enough restorative sleep.”, as optional input rather than an in-class reading task.
