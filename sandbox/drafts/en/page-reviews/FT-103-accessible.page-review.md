...
- Learning target: Use ten matched claims, from “Enough money means different things in different households and places.” to “Enough can be a range and a set of conditions, not one universal number.”, as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned Japanese claim translations are available; this accessible article owns these selective glosses: financial cushion=金銭的な余裕.
