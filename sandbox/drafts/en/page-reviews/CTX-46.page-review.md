...
- Visible target or prompt: Answer a question when you do not know yet: Protect accuracy and commit to a specific follow-up time. / 正確さを守り、具体的な回答時刻を約束しましょう。
- Learning target: Orient the learner to the exact answer a question when you do not know yet outcome before role-play.
...
- Tutor action: Play the senior manager and begin with the first counterpart line.
- Visible target or prompt: A meeting question about an unverified figure; learner is Colleague, tutor is Senior Manager; first tutor line: “What was the confirmed conversion figure last month?”
...
- Component consistency: Uses the shared six-turn dialogue with stable Colleague/Senior Manager roles.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Tutor action: Read only each English senior manager line; do not read the answer choices.
- Visible target or prompt: Tutor-owned Senior Manager lines: “What was the confirmed conversion figure last month?”; “Can you give us an estimate?”; “That's fine. Please send it to everyone.”; “When can finance have the verified total?”
- Learning target: Build receptive control of four senior manager lines needed to understand the workplace task.
...
- Visible target or prompt: verified figure (確認済みの数値); follow up in writing (書面で追って連絡する)
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["I don't have the confirmed figure in front of me.", "I don't have the final cost in front of me.", "I don't have the exact date in front of me.", "I don't have the latest total in front of me."], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “I don't have ___ in front of me” to say which fact you cannot verify yet."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No choices are used; each Japanese cue has one authored complete answer.
- Component consistency: Uses the target-v2 whole-sentence input with explicit checkpoint support.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["Let me check and get back to you by three.", "Let me check and get back to you by noon.", "Let me check and get back to you tomorrow.", "Let me check and get back to you after the meeting."], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; the learner chooses content within a stable pattern frame.
- Component consistency: Uses the shared Student’s sentence and Correction capture component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “Let me check and get back to you ___” to promise a specific follow-up time."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Return to a meeting question about an unverified figure and complete both practical moves in one role-play.
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Is it easy for you to say “I don't know” at work? Why or why not?", "What about you—is it easy for you?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Do not turn an estimate into a confirmed figure / 概算を確定値にしない: An estimate is approximate; a confirmed figure has been checked against a reliable source.
