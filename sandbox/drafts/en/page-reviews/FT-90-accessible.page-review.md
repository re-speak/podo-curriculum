...
- Learning target: Use ten matched claims, from “A desert-island list forces many needs into three objects.” to “The best list depends on what the island already provides.,” as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned accessible-specific Japanese claims are available; this variant owns these selective glosses: essential item=必需品.
