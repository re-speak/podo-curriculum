...
- Visible target or prompt: Turn discussion into a decision: Define today's decision and create the comparison needed to make it. / 今日決める内容を定め、判断に必要な比較を作りましょう。
- Learning target: Orient the learner to the exact turn discussion into a decision outcome before role-play.
...
- Visible target or prompt: A funding discussion without enough comparable evidence; learner is Colleague, tutor is Meeting Chair; first tutor line: “We've discussed options A, B, and C for forty minutes.”
...
- Visible target or prompt: Tutor-owned Meeting Chair lines: “We've discussed options A, B, and C for forty minutes.”; “I don't think we have enough information.”; “Yes. Then we can decide.”; “We need a fair way to compare them first.”
...
- Visible target or prompt: decision criteria (判断基準); come to a decision (結論を出す)
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["The decision we need today is which option to fund.", "The decision we need today is which pilot to run.", "The decision we need today is which date to choose.", "The decision we need today is which supplier to use."], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “The decision we need today is ___” to define the one choice the group must make."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No choices are used; each Japanese cue has one authored complete answer.
- Component consistency: Uses the target-v2 whole-sentence input with explicit checkpoint support.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["Would it help if we compared them against the same three criteria?", "Would it help if we compared them against the same budget?", "Would it help if we compared them against the same timeline?", "Would it help if we compared them against the same risks?"], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; the learner chooses content within a stable pattern frame.
- Component consistency: Uses the shared Student’s sentence and Correction capture component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “Would it help if we compared them against ___?” to propose one fair basis for comparison."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Return to a funding discussion without enough comparable evidence and complete both practical moves in one role-play.
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["When a group cannot decide, what usually helps most: more information, a deadline, or a vote?", "What about you—which one helps most?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Criteria are standards, not options / criteria は選択肢ではなく基準: Options are the things you may choose; criteria are the standards you use to compare them.
