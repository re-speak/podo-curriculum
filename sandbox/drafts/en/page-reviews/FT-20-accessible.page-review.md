...
- Tutor action: Introduce today’s topic, ask the learner to read “One thing you always carry” once, and move on.
- Visible target or prompt: Let's use what's in your bag to talk about your daily life. Please read the title aloud. かばんの中身から、日常生活について話しましょう。タイトルを声に出して読んでください。
- Learning target: Orient the learner to a conversation about “One thing you always carry” without previewing or drilling answers.
- Pedagogical value: Sets the specific discussion can-do for “One thing you always carry” and gives one immediate low-pressure speaking action.
...
- Visible target or prompt: The life inside a bag (かばんの中にある生活): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the optional pre-study article about “One thing you always carry” to seed concrete ideas and topic vocabulary.
- Pedagogical value: Ten or more linked claims give the learner possible angles for the later “One thing you always carry” conversation without prescribing an answer.
...
- Non-target support: The accessible article uses shorter, more direct clauses, aligned Japanese for every claim, and these selective glosses: emergency 緊急時.
...
- Tutor action: Honor the learner’s selected correction timing while discussing “One thing you always carry.”
...
- Learner action: Listen to how the eight-question pool for “One thing you always carry” will be used, then begin the conversation.
...
- Learning target: Frame “One thing you always carry” as reciprocal conversation rather than eight questions to complete in order.
...
- Learner action: Answer “What do the things you carry every day say about your day?” aloud, then develop whichever detail becomes most interesting.
- Tutor action: React or share briefly, then use “What best shows your usual routine?” or another relevant probe rather than asking every printed follow-up.
- Visible target or prompt: What do the things you carry every day say about your day? 普段の持ち物から、あなたの一日について何が分かりますか？
...
- Pedagogical value: The answerable main prompt “What do the things you carry every day say about your day?” opens this angle; “What best shows your usual routine?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “What best shows your usual routine?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
- Article treatment: The prompt stands alone even if pre-study was skipped; article ideas may support the answer to “What do the things you carry every day say about your day?” but are never required.
- Choice/distractor quality: There are no artificial distractors or forced frames; “What might someone get wrong?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What do the things you carry every day say about your day?"]}`
- Visual QA: 360px **pass**; 480px **pass**
- Verdict: **pass**
- Notes: Source-level semantic inspection is complete; root rendered this exact page at 360px and 480px with no overflow and completed the visual and human page audit.
...
- Tutor action: Summarize evidence from the “One thing you always carry” discussion and ask the learner to repeat one useful correction.
