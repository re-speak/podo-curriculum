...
- Visible target or prompt: Interrupt to clarify a key point: Interrupt politely and expose the assumption behind an important date. / 丁寧に割って入り、重要な日程の前提を明らかにしましょう。
- Learning target: Orient the learner to the exact interrupt to clarify a key point outcome before role-play.
...
- Tutor action: Play the presenter and begin with the first counterpart line.
- Visible target or prompt: Checking a proposed launch date; learner is Colleague, tutor is Presenter; first tutor line: “We should be ready to launch on June 12.”
...
- Component consistency: Uses the shared six-turn dialogue with stable Colleague/Presenter roles.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Tutor action: Read only each English presenter line; do not read the answer choices.
- Visible target or prompt: Tutor-owned Presenter lines: “We should be ready to launch on June 12.”; “It's based on the supplier's current estimate.”; “Exactly. It isn't fixed yet.”; “It uses the results from our three largest clients.”
- Learning target: Build receptive control of four presenter lines needed to understand the workplace task.
...
- Visible target or prompt: before we move on (次へ進む前に); underlying assumption (根底にある前提)
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["Sorry to interrupt, but what is that date based on?", "Sorry to interrupt, but what is that figure based on?", "Sorry to interrupt, but what is that forecast based on?", "Sorry to interrupt, but what is that decision based on?"], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “Sorry to interrupt, but what is ___ based on?” to ask for the evidence behind an important claim."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: The examples vary meaningful content instead of presenting a selection task.
- Component consistency: Uses the shared meaning-and-use teaching component with one example block.
- Extracted evidence: `{"targetHighlights": ["So it could change", "それも変わる可能性があるのですね", "So it could change", "それも変わる可能性があるのですね", "So it could change", "それも変わる可能性があるのですね"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are present; learning comes from four useful variations.
- Component consistency: Uses the standard four-line read-aloud model list.
- Extracted evidence: `{"targetHighlights": ["So it could change", "それも変わる可能性があるのですね", "So it could change", "それも変わる可能性があるのですね", "So it could change", "それも変わる可能性があるのですね", "So it could change", "それも変わる可能性があるのですね"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No choices are used; each blank has one answer established by its source sentence.
- Component consistency: Uses the static synchronized shared target-blank input component.
- Extracted evidence: `{"targetHighlights": ["それも変わる可能性があるのですね", "それも変わる可能性があるのですね", "それも変わる可能性があるのですね", "それも変わる可能性があるのですね"], "blankAnswers": ["So it could change", "So it could change", "So it could change", "So it could change"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Non-target support: Row-specific lexical chips support non-target content: ['見込み:estimate', '費用:costs', '顧客実績:client results', '承認:approval'].
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["So it could change if their estimate changes?", "So it could change if the costs rise?", "So it could change if the client results change?", "So it could change if approval is delayed?"], "hintChips": ["見込み:estimate", "費用:costs", "顧客実績:client results", "承認:approval"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; the learner chooses content within a stable pattern frame.
- Component consistency: Uses the shared Student’s sentence and Correction capture component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “So it could change if ___?” to check which assumption could change the result."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Return to checking a proposed launch date and complete both practical moves in one role-play.
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["In meetings, what makes you question a number or forecast?", "What about you—what makes you question a forecast?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Use “based on” to ask for the source, not the reason / 情報源には based on: “What is it based on?” asks for evidence or an assumption; “Why?” can invite a broader explanation.
