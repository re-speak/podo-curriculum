...
- Learner action: Listen to the can-do, then read the exact title “Life in the city or the countryside?” aloud once.
- Tutor action: State the can-do, invite one title reading, then move directly to the optional article page.
- Visible target or prompt: Life in the city or the countryside? / 都会暮らし、それとも田舎暮らし？. Let's compare city life and country life, then explain what could change your choice. / 都会の生活と田舎の生活を比べ、何が変われば選択も変わるか話しましょう。
- Learning target: Orient the learner to a balanced conversation about Life in the city or the countryside? without supplying a preferred answer.
...
- Non-target support: The Japanese can-do “都会の生活と田舎の生活を比べ、何が変われば選択も変わるか話しましょう。” and title “都会暮らし、それとも田舎暮らし？” match the English topic and action.
...
- Learning target: Use ten topic-specific claims, from “Daily access to work, care, education, and transport can outweigh additional private space.” to “Residential preference is dynamic because mobility, relationships, and essential services change over a lifetime.”, as optional input rather than an in-class reading task.
