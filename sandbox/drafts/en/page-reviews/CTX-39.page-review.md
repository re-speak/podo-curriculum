...
- Visible target or prompt: Raise a project risk early: Report the current status and surface the main risk before it becomes a problem. / 現在の状況と主なリスクを分け、問題になる前に共有しましょう。
- Learning target: Orient the learner to the exact raise a project risk early outcome before role-play.
...
- Tutor action: Play the project sponsor and begin with the first counterpart line.
- Visible target or prompt: A status update before a supplier delay; learner is Colleague, tutor is Project Sponsor; first tutor line: “How is the delivery looking today?”
...
- Component consistency: Uses the shared six-turn dialogue with stable Colleague/Project Sponsor roles.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Tutor action: Read only each English project sponsor line; do not read the answer choices.
- Visible target or prompt: Tutor-owned Project Sponsor lines: “How is the delivery looking today?”; “But you sound worried.”; “Thanks for raising it now. What's the fallback?”; “What could change that?”
- Learning target: Build receptive control of four project sponsor lines needed to understand the workplace task.
...
- Visible target or prompt: early warning (早期警告); fallback plan (代替案)
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["We're on track at the moment.", "We're on track for this week.", "We're on track so far.", "We're on track for Friday."], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “We're on track ___” to give the current project status without overstating it."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: The examples vary meaningful content instead of presenting a selection task.
- Component consistency: Uses the shared meaning-and-use teaching component with one example block.
- Extracted evidence: `{"targetHighlights": ["The main risk is that", "主なリスクは", "The main risk is that", "主なリスクは", "The main risk is that", "主なリスクは"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are present; learning comes from four useful variations.
- Component consistency: Uses the standard four-line read-aloud model list.
- Extracted evidence: `{"targetHighlights": ["The main risk is that", "主なリスクは", "The main risk is that", "主なリスクは", "The main risk is that", "主なリスクは", "The main risk is that", "主なリスクは"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No choices are used; each blank has one answer established by its source sentence.
- Component consistency: Uses the static synchronized shared target-blank input component.
- Extracted evidence: `{"targetHighlights": ["主なリスクは", "主なリスクは", "主なリスクは", "主なリスクは"], "blankAnswers": ["The main risk is that", "The main risk is that", "The main risk is that", "The main risk is that"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Non-target support: Row-specific lexical chips support non-target content: ['仕入先:supplier', 'データ:data', '承認:approval', '試験:test'].
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["The main risk is that the supplier may be late.", "The main risk is that the data may be incomplete.", "The main risk is that approval may take longer.", "The main risk is that one test may fail."], "hintChips": ["仕入先:supplier", "データ:data", "承認:approval", "試験:test"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; the learner chooses content within a stable pattern frame.
- Component consistency: Uses the shared Student’s sentence and Correction capture component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “The main risk is that ___” to raise one possible problem before it becomes urgent."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Tutor action: State the transition once and move directly to the activity.
- Visible target or prompt: Return to a status update before a supplier delay and complete both practical moves in one role-play.
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What makes you trust a project status update?", "What about you—what makes a status update trustworthy?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Use “risk” before it happens / 起きる前なら risk: A risk may become a problem later; an issue is already affecting the project now.
