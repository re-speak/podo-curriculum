...
- Learner action: Listen to the can-do, then read the exact lesson title “A useless fact about you” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “A useless fact about you” once, and move on.
- Visible target or prompt: Let's talk about facts that are interesting even when they aren't useful. Please read the title aloud. 役に立たなくても面白い事実について話しましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “A useless fact about you” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “A useless fact about you” and begins with a low-pressure title reading.
...
- Visible target or prompt: The value of useless facts (役に立たない事実の価値): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “A useless fact about you.”
- Pedagogical value: The article moves from “A piece of personal trivia has no obvious utility in work or daily life.” to “One well-chosen oddity can make an otherwise predictable introduction feel genuinely human.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective full glosses (utility (実用性)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this full article owns utility (実用性).
...
- Learner action: Listen to how the eight-question pool for “A useless fact about you” will be used, then begin the conversation.
...
- Learning target: Frame “A useless fact about you” as reciprocal conversation rather than eight questions to complete in order.
