...
- Learner action: Listen to the can-do, then read the exact title “A planned trip or a spontaneous one?” aloud once.
- Tutor action: State the can-do, invite one title reading, then move directly to the optional article page.
- Visible target or prompt: A planned trip or a spontaneous one? / 計画的な旅、それとも気ままな旅？. Let's compare a planned trip and a spontaneous trip, then explain what could change your choice. / 計画的な旅行と行き当たりばったりの旅行を比べ、何が変われば選択も変わるか話しましょう。
- Learning target: Orient the learner to a balanced conversation about A planned trip or a spontaneous one? without supplying a preferred answer.
...
- Non-target support: The Japanese can-do “計画的な旅行と行き当たりばったりの旅行を比べ、何が変われば選択も変わるか話しましょう。” and title “計画的な旅、それとも気ままな旅？” match the English topic and action.
...
- Learning target: Use ten topic-specific claims, from “Flights and popular rooms become harder or more expensive to book near the date.” to “Many good trips use a planned backbone with open space around it.”, as optional input rather than an in-class reading task.
...
- Non-target support: Ten aligned Japanese claims are available; selective gloss support is last-minute plan=直前の計画.
