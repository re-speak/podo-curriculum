...
- Lesson: `sandbox/drafts/en/tracks/3-freetalking/courses/talk-small-things-full/lessons/43-an-embarrassing-memory-that-comes-back-at-night/lesson.html`
- SHA-256: `11bf964f46856c120200d81cf8d497044d3a20e09fab95993ebd466e5ab07ec1`
- Generated: **pass**
...
- Learner action: Listen to the can-do, then read the exact lesson title “An embarrassing memory that comes back at night” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “An embarrassing memory that comes back at night” once, and move on.
- Visible target or prompt: Let's talk about why harmless embarrassing memories can stay with us. Please read the title aloud. 害のない恥ずかしい記憶が残り続ける理由について話しましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “An embarrassing memory that comes back at night” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “An embarrassing memory that comes back at night” and begins with a low-pressure title reading.
...
- Visible target or prompt: Why awkward memories return (気まずい記憶が戻る理由): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “An embarrassing memory that comes back at night.”
- Pedagogical value: The article moves from “An embarrassing moment can resurface vividly long after every witness has forgotten it.” to “The event cannot be edited, but its meaning and emotional weight can continue to change.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective full glosses (unresolved (整理できていない)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this full article owns unresolved (整理できていない).
...
- Learner action: Listen to how the eight-question pool for “An embarrassing memory that comes back at night” will be used, then begin the conversation.
...
- Learning target: Frame “An embarrassing memory that comes back at night” as reciprocal conversation rather than eight questions to complete in order.
...
- Learner action: Respond aloud to “What kinds of trigger cause old embarrassment to resurface?” and develop the most interesting concrete detail.
...
- Visible target or prompt: What kinds of trigger cause old embarrassment to resurface? どのようなきっかけで、昔の恥ずかしさを思い出しますか？
...
- Non-target support: The main prompt has direct Japanese support; the two distinct English follow-ups remain tutor-only and do not crowd the learner page.
- Article treatment: This prompt stands alone if pre-study was skipped; the article may seed ideas for “What kinds of trigger cause old embarrassment to resurface?” but is never required.
...
- Component consistency: Matches the approved Freetalking prompt component: one bilingual talking job, two tutor-only probes, and a Student's sentence feedback box.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What kinds of trigger cause old embarrassment to resurface?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
- Notes: Main prompt, Japanese support, and every follow-up job were reviewed semantically in source; root visual inspection remains pending.
