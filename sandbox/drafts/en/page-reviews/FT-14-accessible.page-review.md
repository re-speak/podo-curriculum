...
- Lesson: `sandbox/drafts/en/tracks/3-freetalking/courses/talk-me-lately-accessible/lessons/14-one-thing-you-still-want-to-do-this-year/lesson.html`
- SHA-256: `10aa949996b71fcaa5c5205fd890005c0e1e3c5ccf1449c0a86c449714eba5c7`
- Generated: **pass**
...
- Tutor action: Introduce today’s topic, ask the learner to read “One thing you still want to do this year” once, and move on.
- Visible target or prompt: Let's choose one goal and find a realistic first step. Please read the title aloud. 目標を一つ選び、現実的な最初の一歩を考えましょう。タイトルを声に出して読んでください。
- Learning target: Orient the learner to a conversation about “One thing you still want to do this year” without previewing or drilling answers.
- Pedagogical value: Sets the specific discussion can-do for “One thing you still want to do this year” and gives one immediate low-pressure speaking action.
...
- Visible target or prompt: Turning a wish into a plan (願いを計画に変える): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the optional pre-study article about “One thing you still want to do this year” to seed concrete ideas and topic vocabulary.
- Pedagogical value: Ten or more linked claims give the learner possible angles for the later “One thing you still want to do this year” conversation without prescribing an answer.
...
- Non-target support: The accessible article uses shorter, more direct clauses, aligned Japanese for every claim, and these selective glosses: vague 曖昧な.
...
- Tutor action: Honor the learner’s selected correction timing while discussing “One thing you still want to do this year.”
...
- Learner action: Listen to how the eight-question pool for “One thing you still want to do this year” will be used, then begin the conversation.
...
- Learning target: Frame “One thing you still want to do this year” as reciprocal conversation rather than eight questions to complete in order.
...
- Learner action: Answer “What can make one goal feel important?” aloud, then develop whichever detail becomes most interesting.
- Tutor action: React or share briefly, then use “What kind of change can a goal bring?” or another relevant probe rather than asking every printed follow-up.
- Visible target or prompt: What can make one goal feel important? 一つの目標が大切に感じられるのは、どんなときですか？
...
- Pedagogical value: The answerable main prompt “What can make one goal feel important?” opens this angle; “What kind of change can a goal bring?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “What kind of change can a goal bring?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
- Article treatment: The prompt stands alone even if pre-study was skipped; article ideas may support the answer to “What can make one goal feel important?” but are never required.
- Choice/distractor quality: There are no artificial distractors or forced frames; “What might you leave until later?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What can make one goal feel important?"]}`
- Visual QA: 360px **pass**; 480px **pass**
- Verdict: **pass**
- Notes: Source-level semantic inspection is complete; root rendered this exact page at 360px and 480px with no overflow and completed the visual and human page audit.
...
- Tutor action: React or share briefly, then use “Is it often time, money, or doubt?” or another relevant probe rather than asking every printed follow-up.
...
- Pedagogical value: The answerable main prompt “What usually stops a goal from moving forward?” opens this angle; “Is it often time, money, or doubt?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “Is it often time, money, or doubt?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
...
- Learner action: Answer “What can make it right to change or drop a goal?” aloud, then develop whichever detail becomes most interesting.
- Tutor action: React or share briefly, then use “What would you refuse to change?” or another relevant probe rather than asking every printed follow-up.
- Visible target or prompt: What can make it right to change or drop a goal? 目標を変えたりやめたりしてよいのは、どんなときですか？
...
- Pedagogical value: The answerable main prompt “What can make it right to change or drop a goal?” opens this angle; “What would you refuse to change?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “What would you refuse to change?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
- Article treatment: The prompt stands alone even if pre-study was skipped; article ideas may support the answer to “What can make it right to change or drop a goal?” but are never required.
- Choice/distractor quality: There are no artificial distractors or forced frames; “When would changing the goal be a good idea?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What can make it right to change or drop a goal?"]}`
- Visual QA: 360px **pass**; 480px **pass**
- Verdict: **pass**
- Notes: Source-level semantic inspection is complete; root rendered this exact page at 360px and 480px with no overflow and completed the visual and human page audit.
...
- Tutor action: Summarize evidence from the “One thing you still want to do this year” discussion and ask the learner to repeat one useful correction.
