...
- Visible target or prompt: Resolve conflicting booking information: Show the discrepancy and leave with written confirmation of the solution. / 情報の食い違いを示し、解決内容を書面で受け取りましょう。
- Learning target: Orient the learner to the exact resolve conflicting booking information outcome before role-play.
...
- Tutor action: Play the hotel clerk and begin with the first counterpart line.
- Visible target or prompt: At check-in with conflicting breakfast information; learner is Traveller, tutor is Hotel Clerk; first tutor line: “Our system shows that breakfast costs extra.”
...
- Component consistency: Uses the shared six-turn dialogue component with stable Traveller/Hotel Clerk roles.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Tutor-owned Hotel Clerk lines: “Our system shows that breakfast costs extra.”; “We'll honor the included breakfast.”; “I'll email a note confirming breakfast for both mornings.”; “There will be no extra charge.”
...
- Visible target or prompt: booking confirmation (予約確認書); discrepancy (食い違い)
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["My confirmation says breakfast is included, whereas your system says it isn't.", "My email says parking is included, whereas your system says it isn't.", "My voucher says two nights, whereas your system says one.", "My confirmation says a double room, whereas your system says a single."], "hintChips": ["朝食込み:breakfast is included", "朝食なし:it isn't", "駐車場込み:parking is included", "駐車料金別:it isn't", "2泊:two nights", "1泊:one", "ダブルルーム:a double room", "シングル:a single"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “My ___ says ___, whereas your system says ___” to compare the two conflicting records."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: The examples vary meaningful content rather than presenting a selection task.
- Component consistency: Uses the shared meaning-and-use teaching component with one example block.
- Extracted evidence: `{"targetHighlights": ["Could you confirm in writing", "書面で確認していただけますか", "Could you confirm in writing", "書面で確認していただけますか", "Could you confirm in writing", "書面で確認していただけますか"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are present; learning comes from four useful variations.
- Component consistency: Uses the standard four-line read-aloud model list.
- Extracted evidence: `{"targetHighlights": ["Could you confirm in writing", "書面で確認していただけますか", "Could you confirm in writing", "書面で確認していただけますか", "Could you confirm in writing", "書面で確認していただけますか", "Could you confirm in writing", "書面で確認していただけますか"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No choices are used; each blank has one answer established by its complete sentence.
- Component consistency: Uses the shared static synchronized target-blank input component.
- Extracted evidence: `{"targetHighlights": ["書面で確認していただけますか", "書面で確認していただけますか", "書面で確認していただけますか", "書面で確認していただけますか"], "blankAnswers": ["Could you confirm in writing", "Could you confirm in writing", "Could you confirm in writing", "Could you confirm in writing"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; each Japanese cue maps to one practised complete sentence.
- Component consistency: Uses the target-v2 shared full-sentence input with an explicit support stage.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["Could you confirm in writing how this will be resolved?", "Could you confirm in writing that breakfast is included?", "Could you confirm in writing the revised price?", "Could you confirm in writing the room type?"], "hintChips": ["どう解決するか:how this will be resolved", "朝食が含まれること:that breakfast is included", "修正後の料金:the revised price", "部屋タイプ:the room type"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: Open production has no fixed choices; the stable frame bounds acceptable answers.
- Component consistency: Uses the shared student-sentence/correction feedback component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “Could you confirm in writing ___?” to ask for written confirmation of the solution."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Which booking detail do you always double-check before a trip, and why?", "What about you—which detail do you check first?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Use “honor” for keeping an agreed term / 合意条件を守る honor; contrast: We'll honor that rate. versus Let me check the confirmation.
