...
- Visible target or prompt: Advocate for an accessibility requirement: Make the essential access requirement non-negotiable and obtain a usable room tonight. / 必須のアクセス条件を明確にし、今夜利用できる部屋を確保しましょう。
- Learning target: Orient the learner to the exact advocate for an accessibility requirement outcome before role-play.
...
- Tutor action: Play the hotel manager and begin with the first counterpart line.
- Visible target or prompt: At a hotel with an inaccessible reserved room; learner is Traveller, tutor is Hotel Manager; first tutor line: “I'm sorry. We can try to move you tomorrow.”
...
- Component consistency: Uses the shared six-turn dialogue component with stable Traveller/Hotel Manager roles.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Tutor-owned Hotel Manager lines: “We can try to move you tomorrow.”; “The room we assigned has three steps.”; “We can move you to our sister hotel.”; “We'll cover the taxi and rate difference.”
...
- Visible target or prompt: reasonable accommodation (合理的配慮); at your expense (そちらの負担で)
...
- Extracted evidence: `{"targetHighlights": ["To be clear,", "is essential, not optional", "はっきり申し上げると、", "必須で、任意ではありません", "To be clear,", "is essential, not optional", "はっきり申し上げると、", "必須で、任意ではありません", "To be clear,", "is essential, not optional", "はっきり申し上げると、", "必須で、任意ではありません"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["To be clear,", "is essential, not optional", "はっきり申し上げると、", "必須で、任意ではありません", "To be clear,", "is essential, not optional", "はっきり申し上げると、", "必須で、任意ではありません", "To be clear,", "is essential, not optional", "はっきり申し上げると、", "必須で、任意ではありません", "To be clear,", "is essential, not optional", "はっきり申し上げると、", "必須で、任意ではありません"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["はっきり申し上げると、", "必須で、任意ではありません", "はっきり申し上げると、", "必須で、任意ではありません", "はっきり申し上げると、", "必須で、任意ではありません", "はっきり申し上げると、", "必須で、任意ではありません"], "blankAnswers": ["To be clear,", "is essential, not optional", "To be clear,", "is essential, not optional", "To be clear,", "is essential, not optional", "To be clear,", "is essential, not optional"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["To be clear, step-free access is essential, not optional.", "To be clear, an accessible bathroom is essential, not optional.", "To be clear, elevator access is essential, not optional.", "To be clear, a ground-floor room is essential, not optional."], "hintChips": ["段差のないアクセス:step-free access", "バリアフリーの浴室:an accessible bathroom", "エレベーターの利用:elevator access", "1階の部屋:a ground-floor room"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “To be clear, ___ is essential, not optional” to state one access requirement that must be met."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; each Japanese cue maps to one practised complete sentence.
- Component consistency: Uses the target-v2 shared full-sentence input with an explicit support stage.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["What alternative can you offer me tonight?", "What alternative can you offer me now?", "What accessible room can you offer me tonight?", "What nearby hotel can you offer me tonight?"], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["When choosing a hotel, which feature makes the biggest difference to your comfort?", "What about you—which feature do you check first?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Use “accessible,” not “handicapped” / handicapped ではなく accessible; contrast: an accessible room versus step-free access
