...
- Learning target: Use ten matched claims, from “A childhood ambition often grows from one vivid but incomplete image of adult work.” to “Even when the occupation changed, the underlying value may connect childhood and adulthood.”, as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned Japanese claim translations are available; this full article owns these selective glosses: underlying value=根底の価値.
