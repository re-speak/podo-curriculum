...
- Visible target or prompt: Deliver bad news with a next step: State the delay plainly and pair it with a concrete recovery step. / 遅れを明確に伝え、具体的な立て直しの一手を添えましょう。
- Learning target: Orient the learner to the exact deliver bad news with a next step outcome before role-play.
...
- Tutor action: Play the director and begin with the first counterpart line.
- Visible target or prompt: A launch that cannot happen on Monday; learner is Colleague, tutor is Director; first tutor line: “Are we still set for Monday's launch?”
...
- Component consistency: Uses the shared six-turn dialogue with stable Colleague/Director roles.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Tutor action: Read only each English director line; do not read the answer choices.
- Visible target or prompt: Tutor-owned Director lines: “Are we still set for Monday's launch?”; “How far behind are we?”; “All right. Talk me through the plan.”; “What date can you commit to instead?”
- Learning target: Build receptive control of four director lines needed to understand the workplace task.
...
- Visible target or prompt: here's where we are (現状はこうです); recovery plan (立て直し計画)
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["I'm afraid we won't be ready for Monday's launch.", "I'm afraid we won't be ready for Friday's review.", "I'm afraid we won't be ready for tomorrow's demo.", "I'm afraid we won't be ready for the client meeting."], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “I'm afraid we won't be ready for ___” to tell the director which event will be delayed."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No choices are used; each Japanese cue has one authored complete answer.
- Component consistency: Uses the target-v2 whole-sentence input with explicit checkpoint support.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["We'll need to push it back by a week, and I have a recovery plan.", "We'll need to push it back by two days, and I have a recovery plan.", "We'll need to push it back until Friday, and I have a recovery plan.", "We'll need to push it back to next month, and I have a recovery plan."], "hintChips": [], "supportStage": "checkpoint", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; the learner chooses content within a stable pattern frame.
- Component consistency: Uses the shared Student’s sentence and Correction capture component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “We'll need to push it back ___, and I have a recovery plan” to give the new timing and show there is a next step."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Return to a launch that cannot happen on monday and complete both practical moves in one role-play.
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["When plans go wrong, do you prefer to hear the bad news immediately or together with a solution?", "What about you—when do you want to hear bad news?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Pair bad news with an owned next step / 悪い知らせには自分が担う次の一手を: A recovery plan is useful only when you can explain the action, owner, and timing.
