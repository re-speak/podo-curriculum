...
- Lesson: `sandbox/drafts/en/tracks/3-freetalking/courses/talk-things-i-like-accessible/lessons/21-a-film-you-never-get-tired-of/lesson.html`
- SHA-256: `03743a792cd0a8a0876acadd7004eba10f94551e3e9a7b8fa18ac22aa9e571bd`
- Generated: **pass**
...
- Learner action: Listen to the can-do, then read the exact lesson title “A film you never get tired of” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “A film you never get tired of” once, and move on.
- Visible target or prompt: Let's talk about a film you can watch again and again. Please read the title aloud. 何度でも見たくなる映画について話しましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “A film you never get tired of” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “A film you never get tired of” and begins with a low-pressure title reading.
...
- Visible target or prompt: Why some films reward another viewing (何度見ても楽しめる映画): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “A film you never get tired of.”
- Pedagogical value: The article moves from “Some films are fun once, while others invite us back many times.” to “The scene we choose for someone else shows what we value in the whole film.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective accessible glosses (rewatch (見返す)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; the accessible article selectively glosses rewatch (見返す).
...
- Learner action: Listen to how the eight-question pool for “A film you never get tired of” will be used, then begin the conversation.
...
- Learning target: Frame “A film you never get tired of” as reciprocal conversation rather than eight questions to complete in order.
...
- Tutor action: Summarize evidence from the “A film you never get tired of” discussion and ask the learner to repeat one useful correction.
