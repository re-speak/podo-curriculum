...
- Learning target: Use ten matched claims, from “A superpower is attractive because it removes an ordinary limit.” to “The best choice depends on the limits placed on the power.,” as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned accessible-specific Japanese claims are available; this variant owns these selective glosses: superpower=超能力.
