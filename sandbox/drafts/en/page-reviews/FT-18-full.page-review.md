...
- SHA-256: `3f2798e95137bcaf89f21bfff5f402ab22099e9e6b059ff724f35e68298c7510`
- Generated: **pass**
...
- Tutor action: Introduce today’s topic, ask the learner to read “A song you keep playing” once, and move on.
- Visible target or prompt: Let's talk about a song that has become part of your life lately. Please read the title aloud. 最近の生活の一部になっている曲について話しましょう。タイトルを声に出して読んでください。
- Learning target: Orient the learner to a conversation about “A song you keep playing” without previewing or drilling answers.
- Pedagogical value: Sets the specific discussion can-do for “A song you keep playing” and gives one immediate low-pressure speaking action.
...
- Visible target or prompt: Why one song stays on repeat (一曲を繰り返し聴く理由): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the optional pre-study article about “A song you keep playing” to seed concrete ideas and topic vocabulary.
- Pedagogical value: Ten or more linked claims give the learner possible angles for the later “A song you keep playing” conversation without prescribing an answer.
...
- Non-target support: The full article uses richer clause structure and more precise vocabulary, aligned Japanese for every claim, and these selective glosses: production 音作り.
...
- Tutor action: Honor the learner’s selected correction timing while discussing “A song you keep playing.”
...
- Learner action: Listen to how the eight-question pool for “A song you keep playing” will be used, then begin the conversation.
...
- Learning target: Frame “A song you keep playing” as reciprocal conversation rather than eight questions to complete in order.
...
- Learner action: Answer “Can music bring back a particular memory for you?” aloud, then develop whichever detail becomes most interesting.
- Tutor action: React or share briefly, then use “Which details return first?” or another relevant probe rather than asking every printed follow-up.
- Visible target or prompt: Can music bring back a particular memory for you? 音楽を聴いて、具体的な思い出が戻ることはありますか？
...
- Pedagogical value: The answerable main prompt “Can music bring back a particular memory for you?” opens this angle; “Which details return first?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “Which details return first?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
- Article treatment: The prompt stands alone even if pre-study was skipped; article ideas may support the answer to “Can music bring back a particular memory for you?” but are never required.
...
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Can music bring back a particular memory for you?"]}`
- Visual QA: 360px **pass**; 480px **pass**
- Verdict: **pass**
- Notes: Source-level semantic inspection is complete; root rendered this exact page at 360px and 480px with no overflow and completed the visual and human page audit.
...
- Tutor action: Summarize evidence from the “A song you keep playing” discussion and ask the learner to repeat one useful correction.
