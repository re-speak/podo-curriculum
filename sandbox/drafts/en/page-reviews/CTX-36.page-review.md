...
- Visible target or prompt: Report a technical blocker usefully: Report the blocker with enough evidence for the team to act immediately. / チームがすぐ対応できるだけの情報を添えてブロッカーを報告しましょう。
- Learning target: Orient the learner to the exact report a technical blocker usefully outcome before role-play.
...
- Tutor action: Play the demo lead and begin with the first counterpart line.
- Visible target or prompt: One hour before a client demo; learner is Colleague, tutor is Demo Lead; first tutor line: “Is the demo setup ready for the client call?”
...
- Component consistency: Uses the shared six-turn dialogue component with stable Colleague/Demo Lead roles.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Tutor-owned Demo Lead lines: “Is the demo setup ready?”; “What changed since the last successful login?”; “That gives me enough to act.”; “I'll restore your demo access now.”
...
- Visible target or prompt: permission error (権限エラー); blocking the demo (デモを妨げている)
...
- Extracted evidence: `{"targetHighlights": ["can't access", "アクセスできません", "can't access", "アクセスできません", "can't access", "アクセスできません"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["can't access", "アクセスできません", "can't access", "アクセスできません", "can't access", "アクセスできません", "can't access", "アクセスできません"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["アクセスできません", "アクセスできません", "アクセスできません", "アクセスできません"], "blankAnswers": ["can't access", "can't access", "can't access", "can't access"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["I can't access the demo environment.", "I can't access the shared folder.", "I can't access the test account.", "I can't access the client dashboard."], "hintChips": ["デモ環境:the demo environment", "共有フォルダ:the shared folder", "テストアカウント:the test account", "顧客ダッシュボード:the client dashboard"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “I can't access ___” to name the exact resource blocking your work."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: The examples vary meaningful content rather than presenting a selection task.
- Component consistency: Uses the shared meaning-and-use teaching component with one example block.
- Extracted evidence: `{"targetHighlights": ["worked", "but now I get", "動きました", "が、今表示されるのは", "worked", "but now I get", "動きました", "が、今表示されるのは", "worked", "but now I get", "動きました", "が、今表示されるのは"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are present; learning comes from four useful variations.
- Component consistency: Uses the standard four-line read-aloud model list.
- Extracted evidence: `{"targetHighlights": ["worked", "but now I get", "動きました", "が、今表示されるのは", "worked", "but now I get", "動きました", "が、今表示されるのは", "worked", "but now I get", "動きました", "が、今表示されるのは", "worked", "but now I get", "動きました", "が、今表示されるのは"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No choices are used; each blank has one answer established by its complete sentence.
- Component consistency: Uses the shared static synchronized target-blank input component.
- Extracted evidence: `{"targetHighlights": ["動きました", "が、今表示されるのは", "動きました", "が、今表示されるのは", "動きました", "が、今表示されるのは", "動きました", "が、今表示されるのは"], "blankAnswers": ["worked", "but now I get", "worked", "but now I get", "worked", "but now I get", "worked", "but now I get"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; each Japanese cue maps to one practised complete sentence.
- Component consistency: Uses the target-v2 shared full-sentence input with an explicit support stage.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["It worked this morning, but now I get a permission error.", "It worked yesterday, but now I get a login error.", "It worked before lunch, but now I get a blank screen.", "It worked on my laptop, but now I get an access error."], "hintChips": ["今朝:this morning", "権限エラー:a permission error", "昨日:yesterday", "ログインエラー:a login error", "昼食前:before lunch", "空白画面:a blank screen", "自分のPC:on my laptop", "アクセスエラー:an access error"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: Open production has no fixed choices; the stable frame bounds acceptable answers.
- Component consistency: Uses the shared student-sentence/correction feedback component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “It worked ___, but now I get ___” to contrast the last success with the current error."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["can't access", "アクセスできません", "worked", "but now I get", "動きました", "が、今表示されるのは"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["can't access", "worked", "but now I get"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What information helps you solve a technical problem fastest?", "What about you—which detail do you ask for first?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Report the symptom, not a guessed cause / 推測した原因ではなく症状を報告; contrast: I get a permission error. versus The server must be broken.
