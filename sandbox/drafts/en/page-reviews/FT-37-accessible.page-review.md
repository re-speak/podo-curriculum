...
- Lesson: `sandbox/drafts/en/tracks/3-freetalking/courses/talk-small-things-accessible/lessons/37-what-you-do-on-a-rainy-day/lesson.html`
- SHA-256: `03ebc17d0da2f99edaccef1901fbee048ed591cdaae81dc927cd6fab1b6c39a9`
- Generated: **pass**
...
- Learner action: Listen to the can-do, then read the exact lesson title “What you do on a rainy day” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “What you do on a rainy day” once, and move on.
- Visible target or prompt: Let's build a rainy day from the first drop to the perfect ending. Please read the title aloud. 雨の降り始めから理想の終わりまで、雨の日を組み立てて話しましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “What you do on a rainy day” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “What you do on a rainy day” and begins with a low-pressure title reading.
...
- Visible target or prompt: What rain changes (雨が変えるもの): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “What you do on a rainy day.”
- Pedagogical value: The article moves from “Rain changes the speed and shape of an ordinary day.” to “Weather does not decide the whole day, but it changes what feels possible.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective accessible glosses (downpour (激しい雨)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this accessible article owns downpour (激しい雨).
...
- Learner action: Listen to how the eight-question pool for “What you do on a rainy day” will be used, then begin the conversation.
...
- Learning target: Frame “What you do on a rainy day” as reciprocal conversation rather than eight questions to complete in order.
...
- Learner action: Answer the standalone question “Which rainy situation would be hardest to deal with?” aloud and develop one interesting detail, example, or reason.
- Tutor action: Ask “Which rainy situation would be hardest to deal with?”, react naturally, and use the most relevant follow-up instead of forcing both.
- Visible target or prompt: Conversation prompt: “Which rainy situation would be hardest to deal with?” / “雨の日のどのような状況が、いちばん大変そうですか？” Tutor follow-ups: “What would make it manageable?” and “Which detail would stay in your memory?”
- Learning target: Answer and develop this page's distinct conversation question in spontaneous English.
- Pedagogical value: The standalone prompt opens one answerable angle, and the follow-ups broaden or deepen the learner's answer.
- Failure diagnoses: A no, an I-don't-know answer, or a general answer must still leave a natural next move; repeated or answer-presuming follow-ups fail the page.
...
- Choice/distractor quality: No fixed answer is implied; the learner and tutor can contribute different defensible views or examples.
- Component consistency: Uses one visible conversation question, one tutor-only follow-up pool, and no competing learner task.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Which rainy situation would be hardest to deal with?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
- Notes: Semantic conversation audit completed against the current English prompt, Japanese prompt, and tutor follow-ups; visual status is recorded separately.
...
- Learner action: Answer the standalone question “What would your perfect rainy day look like?” aloud and develop one interesting detail, example, or reason.
- Tutor action: Ask “What would your perfect rainy day look like?”, react naturally, and use the most relevant follow-up instead of forcing both.
- Visible target or prompt: Conversation prompt: “What would your perfect rainy day look like?” / “理想の雨の日は、どのような一日ですか？” Tutor follow-ups: “How much company would fit the day?” and “What one thing would ruin it?”
- Learning target: Answer and develop this page's distinct conversation question in spontaneous English.
- Pedagogical value: The standalone prompt opens one answerable angle, and the follow-ups broaden or deepen the learner's answer.
- Failure diagnoses: A no, an I-don't-know answer, or a general answer must still leave a natural next move; repeated or answer-presuming follow-ups fail the page.
...
- Choice/distractor quality: No fixed answer is implied; the learner and tutor can contribute different defensible views or examples.
- Component consistency: Uses one visible conversation question, one tutor-only follow-up pool, and no competing learner task.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What would your perfect rainy day look like?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
- Notes: Semantic conversation audit completed against the current English prompt, Japanese prompt, and tutor follow-ups; visual status is recorded separately.
