...
- Lesson: `sandbox/drafts/en/tracks/3-freetalking/courses/talk-small-things-full/lessons/40-a-superstition-you-follow-anyway/lesson.html`
- SHA-256: `20360869c94eede53cd44a939cdf292ba8f17f7a0c2aa3bf8fd78be91419a35f`
- Generated: **pass**
...
- Learner action: Listen to the can-do, then read the exact lesson title “A superstition you follow anyway” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “A superstition you follow anyway” once, and move on.
- Visible target or prompt: Let's talk about why superstitions survive even when people doubt them. Please read the title aloud. 人が疑っていても迷信が残る理由について話しましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “A superstition you follow anyway” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “A superstition you follow anyway” and begins with a low-pressure title reading.
...
- Visible target or prompt: Belief, habit, and luck (信念、習慣、運): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “A superstition you follow anyway.”
- Pedagogical value: The article moves from “A superstition links an action, object, or sign to an outcome without reliable evidence.” to “Even a committed skeptic may preserve one ritual because familiarity can be emotionally reassuring.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective full glosses (ritual (決まった行動)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this full article owns ritual (決まった行動).
...
- Learner action: Listen to how the eight-question pool for “A superstition you follow anyway” will be used, then begin the conversation.
...
- Learning target: Frame “A superstition you follow anyway” as reciprocal conversation rather than eight questions to complete in order.
...
- Learner action: Respond aloud to “Which element of a superstition can remain plausible even to a skeptic?” and develop the most interesting concrete detail.
...
- Visible target or prompt: Which element of a superstition can remain plausible even to a skeptic? 迷信のどのような部分なら、疑う人にも信じられそうですか？
...
- Non-target support: The main prompt has direct Japanese support; the two distinct English follow-ups remain tutor-only and do not crowd the learner page.
- Article treatment: This prompt stands alone if pre-study was skipped; the article may seed ideas for “Which element of a superstition can remain plausible even to a skeptic?” but is never required.
...
- Component consistency: Matches the approved Freetalking prompt component: one bilingual talking job, two tutor-only probes, and a Student's sentence feedback box.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Which element of a superstition can remain plausible even to a skeptic?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
- Notes: Main prompt, Japanese support, and every follow-up job were reviewed semantically in source; root visual inspection remains pending.
...
- Learner action: Respond aloud to “What's the most unusual superstition you've encountered?” and develop the most interesting concrete detail.
...
- Visible target or prompt: Conversation prompt: “What's the most unusual superstition you've encountered?”
...
- Non-target support: The main prompt has direct Japanese support; the two distinct English follow-ups remain tutor-only and do not crowd the learner page.
- Article treatment: This prompt stands alone if pre-study was skipped; the article may seed ideas for “What's the most unusual superstition you've encountered?” but is never required.
...
- Component consistency: Matches the approved Freetalking prompt component: one bilingual talking job, two tutor-only probes, and a Student's sentence feedback box.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["What's the most unusual superstition you've encountered?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Learner action: Respond aloud to “Which superstition deserves to survive as a tradition?” and develop the most interesting concrete detail.
...
- Visible target or prompt: Which superstition deserves to survive as a tradition? どの迷信は、伝統として残す価値がありますか？
...
- Non-target support: The main prompt has direct Japanese support; the two distinct English follow-ups remain tutor-only and do not crowd the learner page.
- Article treatment: This prompt stands alone if pre-study was skipped; the article may seed ideas for “Which superstition deserves to survive as a tradition?” but is never required.
...
- Component consistency: Matches the approved Freetalking prompt component: one bilingual talking job, two tutor-only probes, and a Student's sentence feedback box.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Which superstition deserves to survive as a tradition?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
- Notes: Main prompt, Japanese support, and every follow-up job were reviewed semantically in source; root visual inspection remains pending.
