...
- Lesson: `sandbox/drafts/en/tracks/3-freetalking/courses/talk-small-things-full/lessons/36-a-habit-you-only-have-at-home/lesson.html`
- SHA-256: `9de9fe99004c40cfee66eb546a6a94b13a38fbb2820c9a3ad95d0ef4781272ca`
- Generated: **pass**
...
- Learner action: Listen to the can-do, then read the exact lesson title “A habit you only have at home” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “A habit you only have at home” once, and move on.
- Visible target or prompt: Let's talk about the habits people keep for home. Please read the title aloud. 家でだけする習慣について話しましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “A habit you only have at home” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “A habit you only have at home” and begins with a low-pressure title reading.
...
- Visible target or prompt: Why home changes our behaviour (家で行動が変わる理由): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “A habit you only have at home.”
- Pedagogical value: The article moves from “At home, we can relax the constant work of managing other people's impressions.” to “The useful boundary is not normal versus strange, but harmless privacy versus behaviour that affects others.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective full glosses (suppress (抑える)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this full article owns suppress (抑える).
...
- Learner action: Listen to how the eight-question pool for “A habit you only have at home” will be used, then begin the conversation.
...
- Learning target: Frame “A habit you only have at home” as reciprocal conversation rather than eight questions to complete in order.
