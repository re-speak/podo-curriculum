...
- Visible target or prompt: Negotiate a realistic deadline: Offer a useful interim result and agree on a deadline you can actually meet. / 役立つ中間成果を示し、実際に守れる締め切りに合意しましょう。
- Learning target: Orient the learner to the exact negotiate a realistic deadline outcome before role-play.
...
- Visible target or prompt: A request for analysis sooner than planned; learner is Colleague, tutor is Manager; first tutor line: “Could you send the complete analysis tomorrow?”
...
- Visible target or prompt: Tutor-owned Manager lines: “Could you send the complete analysis tomorrow?”; “Could I have the full version by Thursday?”; “Agreed. I'll chase the data now.”; “When can the complete report be ready?”
...
- Visible target or prompt: full analysis (完全な分析); realistic timeline (現実的な日程)
...
- Extracted evidence: `{"targetHighlights": ["I can", "will take", "送れますが", "かかります", "I can", "will take", "共有できますが", "かかります", "I can", "will take", "送れますが", "かかります"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["I can", "will take", "送れますが", "かかります", "I can", "will take", "共有できますが", "かかります", "I can", "will take", "送れますが", "かかります", "I can", "will take", "渡せますが", "かかります"], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": ["送れますが", "かかります", "共有できますが", "かかります", "送れますが", "かかります", "渡せますが", "かかります"], "blankAnswers": ["I can", "will take", "I can", "will take", "I can", "will take", "I can", "will take"], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Non-target support: Row-specific lexical chips support non-target content: ['要約:summary', '概要:outline', '数値:figures', '下書き:draft'].
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["I can send a summary tomorrow, but the full analysis will take two days.", "I can share the outline today, but the final report will take three days.", "I can send the figures now, but the written review will take a day.", "I can give you a draft Friday, but the final version will take until Monday."], "hintChips": ["要約:summary", "概要:outline", "数値:figures", "下書き:draft"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “I can ___, but ___ will take ___” to offer an interim result and state how long the full work needs."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Pedagogical value: Useful lexical hints support new content while the learner still supplies the target grammar.
- Failure diagnoses: Hints that reveal articles or target grammar would erase the intended learner decision.
- Non-target support: Row-specific lexical chips support non-target content: ['データ:data', '数値:figures', 'チーム:team', '範囲:scope'].
- Article treatment: Hint chips omit articles and auxiliaries, leaving those grammatical choices to the learner.
- Choice/distractor quality: No choices are used; each Japanese cue has one authored complete answer.
- Component consistency: Uses the target-v2 whole-sentence input with explicit supported support.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": ["Thursday is realistic if the data arrives today.", "Friday is realistic if the figures are final tomorrow.", "Monday is realistic if the team approves the draft Friday.", "The end of June is realistic if the scope stays the same."], "hintChips": ["データ:data", "数値:figures", "チーム:team", "範囲:scope"], "supportStage": "supported", "substantivePrompts": []}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Choice/distractor quality: No distractors are used; the learner chooses content within a stable pattern frame.
- Component consistency: Uses the shared Student’s sentence and Correction capture component.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Use “___ is realistic if ___” to propose a workable deadline and the condition it depends on."]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Return to a request for analysis sooner than planned and complete both practical moves in one role-play.
...
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["Would you rather receive a rough answer quickly or a complete answer later, and why?", "What about you—which would you rather receive?"]}`
- Visual QA: 360px **pending**; 480px **pending**
- Verdict: **pass**
...
- Visible target or prompt: Use “realistic” for a date you can defend / 根拠のある日程には realistic: A realistic date is achievable under the stated conditions; it is not just the date you prefer.
