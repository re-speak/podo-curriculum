...
- Learning target: Use ten matched claims, from “A jackpot creates choices before it creates a plan.” to “The useful question is what kind of life the win should support.,” as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned accessible-specific Japanese claims are available; this variant owns these selective glosses: jackpot=大当たり.
