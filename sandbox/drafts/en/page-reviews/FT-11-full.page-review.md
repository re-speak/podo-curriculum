...
- Lesson: `sandbox/drafts/en/tracks/3-freetalking/courses/talk-me-lately-full/lessons/11-a-show-you-cant-stop-watching/lesson.html`
- SHA-256: `62afbff5c3c5f45fa97e976f2a2d122c1d649c923a198c22a661b9166aec13eb`
- Generated: **pass**
...
- Tutor action: Introduce today’s topic, ask the learner to read “A show you can't stop watching” once, and move on.
- Visible target or prompt: Let's talk about what keeps you watching a show. Please read the title aloud. つい見続けてしまう作品について話しましょう。タイトルを声に出して読んでください。
- Learning target: Orient the learner to a conversation about “A show you can't stop watching” without previewing or drilling answers.
- Pedagogical value: Sets the specific discussion can-do for “A show you can't stop watching” and gives one immediate low-pressure speaking action.
...
- Visible target or prompt: Why we keep watching (見続けたくなる理由): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the optional pre-study article about “A show you can't stop watching” to seed concrete ideas and topic vocabulary.
- Pedagogical value: Ten or more linked claims give the learner possible angles for the later “A show you can't stop watching” conversation without prescribing an answer.
...
- Non-target support: The full article uses richer clause structure and more precise vocabulary, aligned Japanese for every claim, and these selective glosses: binge-watch 一気見する, obligation 義務.
...
- Tutor action: Honor the learner’s selected correction timing while discussing “A show you can't stop watching.”
...
- Learner action: Listen to how the eight-question pool for “A show you can't stop watching” will be used, then begin the conversation.
...
- Learning target: Frame “A show you can't stop watching” as reciprocal conversation rather than eight questions to complete in order.
...
- Learner action: Answer “How do you usually discover a new show?” aloud, then develop whichever detail becomes most interesting.
- Tutor action: React or share briefly, then use “Do you trust personal recommendations or an app more?” or another relevant probe rather than asking every printed follow-up.
- Visible target or prompt: How do you usually discover a new show? 普段、新しい作品をどうやって見つけますか？
...
- Pedagogical value: The answerable main prompt “How do you usually discover a new show?” opens this angle; “Do you trust personal recommendations or an app more?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “Do you trust personal recommendations or an app more?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
- Article treatment: The prompt stands alone even if pre-study was skipped; article ideas may support the answer to “How do you usually discover a new show?” but are never required.
- Choice/distractor quality: There are no artificial distractors or forced frames; “What first makes a show look interesting?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
- Extracted evidence: `{"targetHighlights": [], "blankAnswers": [], "hintChips": [], "supportStage": "not-applicable", "substantivePrompts": ["How do you usually discover a new show?"]}`
- Visual QA: 360px **pass**; 480px **pass**
- Verdict: **pass**
- Notes: Source-level semantic inspection is complete; root rendered this exact page at 360px and 480px with no overflow and completed the visual and human page audit.
...
- Choice/distractor quality: There are no artificial distractors or forced frames; “What could persuade you to return to a show?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
...
- Tutor action: React or share briefly, then use “Which commitment would make you stop?” or another relevant probe rather than asking every printed follow-up.
...
- Pedagogical value: The answerable main prompt “When does watching another episode become a bad idea?” opens this angle; “Which commitment would make you stop?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “Which commitment would make you stop?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
...
- Choice/distractor quality: There are no artificial distractors or forced frames; “What tends to happen when you ignore that limit?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
...
- Tutor action: React or share briefly, then use “Do you want a familiar feeling or something different?” or another relevant probe rather than asking every printed follow-up.
...
- Pedagogical value: The answerable main prompt “What kind of show would you like to watch next?” opens this angle; “Do you want a familiar feeling or something different?” can turn a first response into a more specific exchange.
- Failure diagnoses: If the answer remains vague after “Do you want a familiar feeling or something different?”, the learner needs concrete-detail scaffolding for this topic rather than forced pattern practice.
- Non-target support: The main prompt has aligned Japanese; the English follow-ups stay tutor-only so they support conversation without loading the learner’s page.
...
- Choice/distractor quality: There are no artificial distractors or forced frames; “Where would you look for a recommendation?” offers a distinct optional direction for a genuine follow-up.
- Component consistency: Matches the approved FT prompt component: one bilingual learner question, page-specific tutor probes, and a feedback box labeled Student’s sentence.
...
- Tutor action: Summarize evidence from the “A show you can't stop watching” discussion and ask the learner to repeat one useful correction.
