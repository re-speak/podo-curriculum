...
- Lesson: `sandbox/drafts/en/tracks/3-freetalking/courses/talk-small-things-full/lessons/42-a-rule-that-only-made-sense-in-your-family/lesson.html`
- SHA-256: `ecf0ee85f12e19c636011b21a83ff0fd146a01294258fe26b1789701d2de6acc`
- Generated: **pass**
...
- Learner action: Listen to the can-do, then read the exact lesson title “A rule that only made sense in your family” aloud once.
- Tutor action: Introduce the topic, ask the learner to read “A rule that only made sense in your family” once, and move on.
- Visible target or prompt: Let's talk about why household rules make sense in one home and seem strange in another. Please read the title aloud. 家庭の決まりが、ある家では自然で別の家では不思議に見える理由について話しましょう。 タイトルを声に出して読んでください。
- Learning target: Orient the learner to a live conversation about “A rule that only made sense in your family” without previewing answers.
- Pedagogical value: Sets one observable speaking outcome for “A rule that only made sense in your family” and begins with a low-pressure title reading.
...
- Visible target or prompt: Every home makes a small culture (どの家庭にも小さな文化がある): Did you have any questions about the article? 記事について何か質問はありましたか？
- Learning target: Use the ten-claim pre-study article to seed concrete language and viewpoints for “A rule that only made sense in your family.”
- Pedagogical value: The article moves from “Every household develops rules that appear self-evident to the people living within it.” to “The rules retold years later become part of the story a family tells about itself.,” giving the later prompt pool multiple defensible angles.
- Failure diagnoses: No article question is not a failure; difficulty with the selective full glosses (inherited (受け継いだ)) identifies a local vocabulary support need.
- Non-target support: All ten claims have aligned Japanese support; this full article owns inherited (受け継いだ).
...
- Learner action: Listen to how the eight-question pool for “A rule that only made sense in your family” will be used, then begin the conversation.
...
- Learning target: Frame “A rule that only made sense in your family” as reciprocal conversation rather than eight questions to complete in order.
