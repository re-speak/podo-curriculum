...
- Learning target: Use ten matched claims, from “A social-media break can range from a brief experiment to a permanent boundary.” to “The deeper test is not endurance alone but which attention, relationships, or functions we want to reclaim.”, as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned Japanese claim translations are available; this full article owns these selective glosses: none.
