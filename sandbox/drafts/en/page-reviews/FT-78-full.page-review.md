...
- Learning target: Use ten matched claims, from “A school nickname may grow from a name, habit, private joke, or accidental moment.” to “A lasting nickname works only when recognition and the owner's comfort coexist.”, as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned Japanese claim translations are available; this full article owns these selective glosses: consent=同意.
