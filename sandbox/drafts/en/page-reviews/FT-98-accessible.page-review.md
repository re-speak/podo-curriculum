...
- Learning target: Use ten matched claims, from “Upbringing means the environment and experiences that shape someone while growing up.” to “The exercise shows which parts of identity feel shaped and which feel chosen.,” as optional topic input rather than an in-class reading task.
...
- Non-target support: Ten aligned accessible-specific Japanese claims are available; this variant owns these selective glosses: upbringing=育った環境.
