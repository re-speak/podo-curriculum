...
`sandbox/authoring/kr/trial/reports/trial-1-report.html` is the 니즈 파악 →
리포트 & 플랜 deck.
...
SOURCE = (REPO / "sandbox" / "authoring" / "kr" / "trial" / "reports" /
          "trial-1-report.html")

# Where a flattened basename is looked up, in order.
ASSET_ROOTS = (REPO / "sandbox" / "authoring" / "kr" / "trial" / "assets",
               REPO / "shared" / "assets")
...
spec:
  ...
  teaches: {{}}
  prerequisites: []
  source: sandbox/authoring/kr/trial/reports/{source}
