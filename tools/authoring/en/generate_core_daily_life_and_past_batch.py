...
LESSONS = {
    25: dict(slug="im-working-from-home-today", title="I'm working from home today", ko="오늘은 재택근무 중이에요", ja="今日は在宅勤務をしています",
        ...
        p2=rows(("{t}What are you{/t} {t}doing{/t}?", "{t}何を{/t}{t}していますか{/t}？", "What are you doing?"), ("{t}What are you{/t} {t}reading{/t} now?", "今{t}何を{/t}{t}読んでいますか{/t}？", "What are you reading now?"), ("{t}What are you{/t} {t}making{/t}?", "{t}何を{/t}{t}作っていますか{/t}？", "What are you making?"), ("{t}What are you{/t} {t}watching{/t} today?", "今日は{t}何を{/t}{t}見ていますか{/t}？", "What are you watching today?")), omit_reorder=(1, 2),
    ...
    26: dict(slug="i-usually-drive-but-today-im-walking", title="I usually drive, but today I'm walking", ko="보통 운전하지만 오늘은 걸어요", ja="普段は車ですが、今日は歩いています",
        ...
        p2=rows(("{t}But today I'm{/t} {t}walking{/t}.", "{t}でも今日は{/t}{t}歩いています{/t}。", "But today I'm walking."), ("{t}But today I'm{/t} {t}working at home{/t}.", "{t}でも今日は{/t}{t}家で働いています{/t}。", "But today I'm working at home."), ("{t}But today I'm{/t} {t}taking the train{/t}.", "{t}でも今日は{/t}{t}電車で行っています{/t}。", "But today I'm taking the train."), ("{t}But today I'm{/t} {t}driving{/t}.", "{t}でも今日は{/t}{t}車で行っています{/t}。", "But today I'm driving.")), omit_reorder=(2,), omit_choice=(1,),
    ...
    27: dict(slug="i-like-cooking", title="I like cooking", ko="요리하는 걸 좋아해요", ja="料理が好きです",
        ...
        p1=rows(("{t}I like{/t} {t}cooking{/t}.", "{t}料理すること{/t}が{t}好きです{/t}。", "I like|cooking."), ("{t}I like{/t} {t}walking to work{/t}.", "{t}歩いて通勤すること{/t}が{t}好きです{/t}。", "I like|walking to work."), ("{t}I like{/t} {t}reading{/t}.", "{t}読書{/t}が{t}好きです{/t}。", "I like|reading."), ("{t}I like{/t} {t}traveling with friends{/t}.", "{t}友だちと旅行すること{/t}が{t}好きです{/t}。", "I like|traveling with friends.")), omit_reorder=(1,),
    ...
    28: dict(slug="are-you-free-on-friday", title="Are you free on Friday?", ko="금요일에 시간 있어요?", ja="金曜日は空いていますか？",
        ...
        p1=rows(("{t}Are you free on{/t} Friday?", "{t}金曜日は空いていますか{/t}？", "Are you free|on Friday?"), ("{t}Are you free on{/t} Saturday morning?", "{t}土曜日の午前は空いていますか{/t}？", "Are you free|on Saturday morning?"), ("{t}Are you free on{/t} Sunday?", "{t}日曜日は空いていますか{/t}？", "Are you free|on Sunday?"), ("{t}Are you free on{/t} Tuesday afternoon?", "{t}火曜日の午後は空いていますか{/t}？", "Are you free|on Tuesday afternoon?")),
    ...
    34: dict(slug="i-didnt-sleep-well", title="I didn't sleep well", ko="잠을 잘 못 잤어요", ja="よく眠れませんでした",
        ...
        p2=rows(("{t}I had too much{/t} coffee.", "コーヒーを{t}飲みすぎました{/t}。", "I had|too much coffee."), ("{t}I had too many{/t} meetings.", "会議が{t}多すぎました{/t}。", "I had|too many meetings."), ("{t}I had too much{/t} work.", "仕事が{t}多すぎました{/t}。", "I had|too much work."), ("{t}I had too many{/t} emails.", "メールが{t}多すぎました{/t}。", "I had|too many emails.")), omit_reorder=(1, 2), omit_choice=(2,),
        rules=(("Didn't carries the past, so use the plain verb after it.", "過去は didn't が表すので、そのあとは動詞の原形を使います。"), ("Use too much for an amount you do not count and too many for things you do.", "数えない量には too much、数えられる物には too many を使います。")), prompt=("What usually helps you recover after a bad night's sleep?", "よく眠れなかった翌日は、何をすると回復できますか？")),
...
27: dict(new="like|好き; love|大好き; hate|大嫌い; cooking|料理すること; walking|歩くこと; running|走ること; traveling|旅行すること", recycled="walk|歩く|CORE-26", assumed="cook|料理する; travel|旅行する; read|読む; reading|読書; cleaning|掃除; writing|書くこと; flying|飛行機に乗ること; work|仕事; friends|友だち", receptive="What do you like doing?|何をするのが好きですか？; not really my thing|あまり好みではない"),
28: dict(new="free|空いている; Friday|金曜日; Saturday|土曜日; Sunday|日曜日; Tuesday|火曜日; Would you like to ...?|…しませんか？; Yes, I'd love to.|ぜひ。; Sorry, I can't.|すみません、無理です。", recycled="", assumed="dinner|夕食; lunch|昼食; movie|映画; walk|散歩; see|見る; go|行く; day|曜日; morning|午前; afternoon|午後", receptive="How about ...?|…はどうですか？"),
...
34: dict(new="didn't|～しなかった; sleep well|よく眠る; go out|外出する; too much|多すぎる; too many|多すぎる; unfortunately|残念ながら; That's why.|だからです。", recycled="had|have の過去形|CORE-32; coffee|コーヒー|CORE-9", assumed="eat|食べる; finish|終える; breakfast|朝食; work|仕事; food|食べ物; homework|宿題; meetings|会議; emails|メール", receptive="What happened?|どうしたのですか？"),
...
for n in NUMBERS:
    ...
    correct = {
      ...
      26: (("usually drive", "usually walk", "usually take the train", "usually work"), ("walking", "working", "taking", "driving")),
      ...
      34: (("sleep", "eat", "go", "finish"), ("too much", "too many", "too much", "too many")),
    ...
    wrong = {
      ...
      26: (("drive usually", "walk usually", "take usually the train", "work usually"), ("walk", "work", "take", "drive")),
      ...
      34: (("slept", "ate", "went", "finished"), ("too many", "too much", "too many", "too much")),
...
26: dict(model=dlg("Coworker",0,0,("How do you usually get to work?","普段はどうやって通勤しますか？"),("What's different today?","今日は何が違いますか？"),("And how do you travel most days?","では、普段はどうやって通勤しますか？"),("I usually drive to work.","普段は車で通勤します。")), wild=dlg("Coworker",2,2,("How do you usually get to work?","普段はどうやって通勤しますか？"),("And today?","今日は？"),("Sorry, how are you going today?","すみません、今日はどうやって行きますか？"),("But today I'm taking the train.","でも今日は電車で行っています。"))),
27: dict(model=dlg("Friend",0,0,("What do you like doing?","何をするのが好き？"),("Anything you feel strongly about?","大好きなことや苦手なことは？"),("What do you like most?","一番好きなのは？"),("I like cooking.","料理が好きです。")), wild=dlg("Friend",3,3,("What do you like doing on vacation?","休暇中は何をするのが好き？"),("What about flying?","飛行機はどう？"),("So what do you like doing?","では、何をするのが好き？"),("I like traveling with friends.","友だちと旅行するのが好きです。"))),
