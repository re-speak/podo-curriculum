...
VOCAB = {
    60: dict(new="window|窓; close|閉める; mind|気にする; could|〜してもらえる; would|〜していただける", recycled="open|開ける|CORE-10", assumed="door|ドア; check|確認する; file|ファイル; send|送る; email|メール; thanks|ありがとう; thank you|ありがとう; no rush|急ぎではない", receptive="favor|お願い; impose|負担をかける; urgent|緊急の"),
    61: dict(new="chair|椅子; go ahead|どうぞ; please do|ぜひどうぞ", recycled="window|窓|CORE-60; mind|気にする|CORE-60; open|開ける|CORE-10", assumed="sit|座る; use|使う; photo|写真; take|撮る; rather|むしろ; keep it closed|閉めたままにする; sorry|すみません; perfect|ちょうどよい; thank you|ありがとう; of course|もちろん; go through|先へ進む", receptive="permission|許可; bother|迷惑をかける; sorry, someone's sitting there|すみません、そこには人が座っています"),
    62: dict(new="meeting room|会議室; next train|次の電車; leaves|出発する; know|分かる; tell|教える", recycled="could|〜してもらえる|CORE-60; station|駅|CORE-7; bank|銀行|CORE-7; café|カフェ|CORE-7; shop|店|CORE-10; meeting|会議|CORE-30; upstairs|上の階|CORE-56", assumed="opens|開く; starts|始まる; closes|閉まる; blocks away|ブロック先; departure time|出発時刻; help|助け; thank you|ありがとう; great|分かった; perfect|よかった; go|行く", receptive="sorry to bother you|お邪魔してすみません; by any chance|もしかして; platform|ホーム"),
    63: dict(new="generally|たいてい; tea|紅茶; noisy|騒がしい; avoid|避ける; tend|傾向がある", recycled="prefer|より好む|CORE-42; coffee|コーヒー|CORE-9; café|カフェ|CORE-7; restaurant|レストラン|CORE-10; crowded|混んでいる|CORE-44; expensive|高い|CORE-19; busy|人が多い|CORE-30", assumed="train|電車; buses|バス; mornings|朝; evenings|夜; places|場所; kinds|種類; strong preference|強い好み; great|よかった; go in|中に入る; take it|それに乗る", receptive="in general|一般に; as a rule|概して"),
    64: dict(new="laptop|ノートパソコン; charge|充電する; cable|ケーブル; restart|再起動する; turn on|電源が入る; tried|試した; won't|どうしても〜しない", recycled="print|印刷する|CORE-41; printer|プリンター|CORE-38; open|開く|CORE-10", assumed="phone|携帯; door|ドア; check|確認する; another way|別の方法; broken|壊れている; works|動く; handout|資料; let you know|知らせる; other handle|別の取っ手; nothing|何もない; great|よかった", receptive="malfunction|不具合; it's playing up|調子が悪い; that did the trick|それで直った"),
    ...
    66: dict(new="more time|もっと時間; more money|もっとお金; free month|1か月の休み; abroad|海外; bigger|より広い; won|当たった; anywhere|どこでも", recycled="would|〜するだろう|CORE-60; could|〜できたら|CORE-60; move|引っ越す|CORE-37", assumed="travel|旅行する; study|勉強する; work at home|家で働く; room|部屋; Osaka|大阪; sounds fun|楽しそう; sounds peaceful|落ち着きそう", receptive="imaginary|想像上の; in a perfect world|理想を言えば; realistically|現実的には"),
    67: dict(new="free time|自由な時間; energy|元気; quieter|より静かな; schedule|予定; wish|願う", recycled="could|〜できたら|CORE-60; would|〜だろう|CORE-60; drive|運転する|CORE-14; work from home|在宅勤務をする|CORE-25", assumed="cook|料理する; travel|旅行する; better|より上手に; room|部屋; nothing comes to mind|何も思いつかない; good idea|いい考え; help a lot|とても助かる", receptive="dissatisfaction|不満; if only|さえあれば; oh well|まあ仕方ない"),
