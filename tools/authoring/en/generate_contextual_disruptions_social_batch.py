...
LESSONS = {
    13: dict(
        ...
        p2=dict(
            ...
            rows=rows(
                ...
                ("{t}What's the earliest{/t} train {t}you can put us on{/t}?", "{t}いちばん早い{/t}電車で、{t}乗せてもらえるのはどれですか{/t}？", "What's the earliest|train|you can put us on?"),
                ...
                ("{t}What's the earliest{/t} shuttle {t}you can put us on{/t}?", "{t}いちばん早い{/t}シャトルで、{t}乗せてもらえるのはどれですか{/t}？", "What's the earliest|shuttle|you can put us on?"),
            ),
    ...
    17: dict(
        ...
        vocab=("minibar charge|ミニバー料金; itemised bill|明細付き請求書; remove the charge|料金を削除する; late checkout fee|レイトチェックアウト料金", "charge|料金|CORE-64; bill|請求書|CORE-49", "laundry|ランドリー; breakfast|朝食; parking|駐車; date|日付; room number|部屋番号; total|合計", "adjusted|修正された; amount due|支払額; gate record|ゲート記録"),
    ),
    18: dict(
    ...
    21: dict(
        ...
        vocab=("no pressure|無理にとは言わない; meet you there|そこで会う; feel free to|自由に〜する", "nearby|近くで|CORE-15; free|時間がある|CORE-28", "dinner|夕食; lunch|昼食; coffee|コーヒー; dessert|デザート; join us|一緒に参加する; come with me|私と一緒に来る; bring a friend|友達を連れてくる", "heading back|戻るところ; language exchange|言語交流"),
    ),
    22: dict(
        ...
        vocab=("meet halfway|歩み寄る; work for both of us|二人に都合がよい; I see your point|言い分は分かる", "prefer|〜のほうを好む|CORE-42; route|経路|CORE-59", "nearby|近く; museum|美術館; market|市場; short route|短い経路; taxi|タクシー; dinner|夕食", "compromise|妥協; full route|全コース; waste the afternoon|午後を無駄にする; can live with that|それなら受け入れられる"),
    ),
    23: dict(
        ...
        vocab=("I didn't realise|気づかなかった; no offence intended|悪気はない; got it wrong|やり方を間違えた; What I meant was|私が言いたかったのは; get some air|外の空気を吸う", "full|満腹の|CORE-57", "polite|丁寧な; tired|疲れた; bored|退屈した; upset|腹を立てた; respect|敬意; formal|堅い; interrupted|話を遮った", "hardly touched|ほとんど食べなかった; no harm done|大丈夫; uncomfortable|居心地が悪い"),
    ),
    24: dict(
