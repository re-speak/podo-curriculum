...
12: dict(slug="i-start-work-at-nine", title="I start work at nine", ko="아홉 시에 일을 시작해요", ja="9時に仕事を始めます", goal=("Say what you regularly do and when.", "ふだんすることと、その時間を言いましょう。"),
 p1=rows(("{t}I start work at{/t} nine.", "9時に{t}仕事を始めます{/t}。", "I|start work|at|nine."),("{t}I start work at{/t} eight thirty.", "8時半に{t}仕事を始めます{/t}。", "I|start work|at|eight thirty."),("{t}I start work at{/t} ten.", "10時に{t}仕事を始めます{/t}。", "I|start work|at|ten."),("{t}I start work at{/t} seven thirty.", "7時半に{t}仕事を始めます{/t}。", "I|start work|at|seven thirty.")),
...
18: dict(slug="can-you-drive", title="Can you drive?", ko="운전할 수 있어요?", ja="運転できますか？", goal=("Ask about an ability and contrast what you can and cannot do.", "できることをたずね、できることとできないことを対比しましょう。"),
 p1=rows(("{t}Can you{/t} drive?", "運転{t}できますか{/t}？", "Can you|drive?"),("{t}Can he{/t} swim?", "彼は泳ぐことが{t}できますか{/t}？", "Can he|swim?"),("{t}Can you{/t} cook?", "料理が{t}できますか{/t}？", "Can you|cook?"),("{t}Can they{/t} ski?", "彼らはスキーが{t}できますか{/t}？", "Can they|ski?")),
 omit_reorder=(1,),
...
23: dict(slug="two-cups-of-coffee", title="Two cups of coffee", ko="커피 두 잔", ja="コーヒーを2杯", goal=("Ask for an amount of something that is not counted directly.", "直接数えないものの量をたずねたり、頼んだりしましょう。"),
 ...
 p2=rows(("{t}How much{/t} rice {t}do we need{/t}?", "ご飯は{t}どのくらい{/t}{t}必要ですか{/t}？", "How much|rice|do we|need?"),("{t}How many{/t} bottles {t}do we need{/t}?", "ボトルは{t}何本{/t}{t}必要ですか{/t}？", "How many|bottles|do we|need?"),("{t}How much{/t} coffee {t}do we need{/t}?", "コーヒーは{t}どのくらい{/t}{t}必要ですか{/t}？", "How much|coffee|do we|need?"),("{t}How many{/t} cups {t}do we need{/t}?", "カップは{t}いくつ{/t}{t}必要ですか{/t}？", "How many|cups|do we|need?")),
...
18: dict(
 ...
 rules=(("Put a plain verb after can", "can の後ろは動詞の原形", "<b>Can</b> + 人 + 動詞の原形 + ?", "Ability question", "できるかの質問", ("<b>Can you drive</b>?", "<b>Can he swim</b>?")), ("Contrast can and can't", "can と can't を対比する", "I <b>can</b> + 動作, but I <b>can't</b> + 動作", "Two abilities", "二つのできること", ("I <b>can</b> walk, but I <b>can't</b> run.", "I <b>can</b> cook, but I <b>can't</b> bake."))),
...
23: dict(
 meanings=(("Use a container or piece word to count food and drink.", "容器や単位の語を使って食べ物や飲み物を数えるときに使います。"), ("Use How much for an amount you do not count, and How many for things you do.", "数えない量には How much、数えられる物には How many を使います。")),
 writes=(("Now use “___ cups / bottles / pieces of ___, please” to order a real amount.", "では、「___ cups / bottles / pieces of ___, please」を使って、実際の量で注文してください。"), ("Now use “How much / How many ___ do we need?” to ask about one amount.", "では、「How much / How many ___ do we need?」を使って、一つの量をたずねてください。")),
 freetalk=("Answer my question, then ask me too. Use today’s patterns only if they fit naturally.", "私の質問に答えて、それから私にも聞いてください。今日のパターンは自然に合うときだけ使いましょう。"),
 freetalk_title=("Something you buy too much of", "買いすぎるもの"),
 role_ja="友達",
 translate_hints=(
  (("コーヒー", "coffee"), ("水", "water"), ("ケーキ", "cake"), ("ご飯", "rice")),
  (("ご飯", "rice"), ("ボトル", "bottles"), ("コーヒー", "coffee"), ("カップ", "cups")),
 ),
 ...
 rules=(("Count the container, then add of", "容器を数えて of を加える", "数 + 容器<b>-s</b> + <b>of</b> + 品物", "Count by container", "容器で数える", ("two <b>cups of</b> coffee", "two <b>bottles of</b> water")), ("How much for amounts, How many for things", "量は How much、物は How many", "<b>How much</b> / <b>How many</b> + 名詞 + do we need?", "Ask the amount", "量をたずねる", ("<b>How much</b> rice do we need?", "<b>How many</b> bottles do we need?"))),
