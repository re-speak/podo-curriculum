...
REWRITES = {
    ...
    33: [
        reviewed("Which is harder to refuse: a friend's homemade dish or an expensive restaurant dish?", "友人の手料理とレストランの高価な料理では、どちらが断りにくいですか？", ("Why does that one create pressure?", "When would refusal be easier?"), ("Why does that one create pressure?", "When would refusal be easier?")),
        ...
        reviewed("Where is it hardest to refuse food: someone's home, work, or a restaurant?", "食べ物を断りにくいのは、誰かの家、職場、レストランのどこですか？", ("What makes that place difficult?", "What could someone say politely?"), ("What kind of pressure appears there?", "When is refusing still reasonable?")),
