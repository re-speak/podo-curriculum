...
TOPICS = {
    10: {
        ...
        "prompts": [
            prompt("A new interest", "新しい興味", "What kind of new interest could easily catch your attention?", "どんな新しいことなら、すぐ興味を持てそうですか？", ["What would make it appealing?", "Where might you first encounter it?"]),
            ...
            prompt("How it began", "始めたきっかけ", "What might turn your curiosity into a real interest?", "何があれば、あなたの好奇心が本当の興味に変わりそうですか？", ["What would make you try it?", "Could your interest grow unexpectedly?"]),
            prompt("Time for it", "使っている時間", "How would you make room for a new interest?", "新しい興味のために、あなたならどう時間を作りますか？", ["Which part of your week would be easiest to use?", "What might get in the way?"]),
            prompt("Who knows", "知っている人", "Who would be easiest for you to tell about a new interest?", "新しい興味について、あなたは誰にいちばん話しやすいですか？", ["What makes that person easy to talk to?", "Which reaction would encourage you?"]),
            ...
            prompt("What it replaces", "代わりに減ったこと", "When would a new interest be worth giving up other free time for you?", "あなたなら、どんなときに新しい興味のためにほかの自由時間を減らしてもよいと思いますか？", ["What would make the trade-off worthwhile?", "What would you not give up for it?"], full_followups=["What would make the trade-off worthwhile?", "What would you keep protected?"]),
            prompt("Where it goes", "これから", "Where could a new interest lead you after the first few months?", "新しい興味は、最初の数か月のあと、あなたをどこへ連れていきそうですか？", ["What would progress look like for you?", "What might make you continue?"], full="Where could a new interest take you after its first few months?", full_followups=["What might progress look like for you?", "What could make you continue?"]),
        ],
    },
    11: {
        ...
        "prompts": [
            ...
            prompt("A show you dropped", "途中でやめた作品", "What usually makes someone stop watching a show halfway?", "作品を途中で見るのをやめるのは、ふつうどんな理由からですか？", ["Which problem loses attention fastest?", "What might make it worth trying again?"], full_followups=["Which problem loses attention fastest?", "What could make it worth revisiting?"]),
    ...
    12: {
        ...
        "prompts": [
            prompt("A remembered compliment", "覚えている褒め言葉", "What kind of compliment would stay with you for years?", "どんな褒め言葉なら、あなたの心に何年も残りそうですか？", ["Which detail would make it memorable?", "Whose words would matter most?"]),
            ...
            prompt("Praise you gave", "自分が伝えた言葉", "What can make you want to give someone a real compliment?", "誰かを心から褒めたいと思うのは、どんなときですか？", ["Which effort would deserve praise?", "What would make you say it aloud?"]),
    ...
    13: {
        ...
        "prompts": [
            ...
            prompt("The full plan", "全体の予定", "How much structure would your ideal weekend have?", "理想の週末には、どのくらい予定を入れたいですか？", ["Which part would be worth planning?", "How much time would you leave open?"]),
            prompt("Who with", "誰と", "Would you rather spend more of this weekend alone or with someone?", "今週末は、一人で過ごす時間と誰かと過ごす時間のどちらを増やしたいですか？", ["What makes that choice appealing now?", "What balance would feel right?"]),
            prompt("Looking forward", "楽しみなこと", "What part of this weekend are you most looking forward to?", "今週末の何をいちばん楽しみにしていますか？", ["Why does that part matter now?", "What would make it even better?"]),
            ...
            prompt("Still undecided", "まだ決めていないこと", "Which weekend decisions would you make in advance?", "週末について、あなたなら何を前もって決めますか？", ["Which information would help most?", "What could wait until the day itself?"]),
            prompt("If it falls through", "予定がなくなったら", "If a plan fell through this weekend, how would you use the time instead?", "もし週末の予定がなくなったら、その時間をどう使いますか？", ["Would you prefer the backup in any way?", "Would anyone else need to know about the change?"]),
        ],
    },
    14: {
        ...
        "prompts": [
            ...
            prompt("What you dropped", "あきらめたこと", "When can giving up on a goal be the right choice?", "目標をあきらめることが正しい選択になるのは、どんなときですか？", ["Which kind of goal may need to change?", "What should make someone continue instead?"]),
            prompt("Who would notice", "気づく人", "If you completed a personal goal, who might notice?", "自分の目標を達成したら、誰が気づきそうですか？", ["Would anyone else's daily life change?", "Who might you want to tell first?"]),
    ...
    15: {
        ...
        "prompts": [
            ...
            prompt("A changed mind", "変わった考え", "What can change someone's view of a kind of spending?", "ある支出についての見方が変わるのは、どんなきっかけからですか？", ["Which life change could matter most?", "How much can another person's opinion influence it?"], full="What can change someone's judgment of a spending category?", full_followups=["Which change in circumstances could matter most?", "How much can another person's experience influence it?"]),
    ...
    16: {
        ...
        "prompts": [
            prompt("A recent first", "最近の初めて", "What new experience would you be willing to try this month?", "今月、どんな新しいことなら試してみたいですか？", ["What makes it worth trying?", "How might it feel to be new at it?"]),
            prompt("Feeling new", "初めての感覚", "What part of being a beginner would feel most uncomfortable to you?", "初心者でいることの何が、あなたにはいちばん居心地悪く感じそうですか？", ["What would make the feeling easier?", "When could it become enjoyable?"], full="Which part of being a beginner would feel most uncomfortable to you?", full_followups=["What would make the feeling easier?", "When could it become enjoyable?"]),
            ...
            prompt("The first before that", "その前の初めて", "Which first-time experiences tend to become memorable?", "どんな初めての体験が記憶に残りやすいですか？", ["Which detail makes them stand out?", "Can an awkward start improve the memory?"]),
            ...
            prompt("The next first", "次の初めて", "Which new experience would you most like to try next?", "次にいちばん試してみたい新しい体験は何ですか？", ["What makes it appealing to you?", "What would make the timing right?"]),
        ],
    },
    17: {
        ...
        "prompts": [
            prompt("A quiet win", "静かな成功", "What kind of small win would matter to you even if nobody noticed?", "誰にも気づかれなくても、あなたにとって大切な小さな成功とは何ですか？", ["What effort might it take?", "Why would that win still matter to you?"]),
            ...
            prompt("Who understands", "分かってくれる人", "What helps you understand another person's quiet effort?", "人に見えにくい努力を理解するために、あなたは何を知りたいですか？", ["Which detail might they need to explain?", "Could sharing it change how the effort feels?"]),
            ...
            prompt("What's still difficult", "まだ難しいこと", "What would deserve credit if you were having a difficult month?", "大変な一か月を過ごしているなら、どんなことを評価したいですか？", ["What might still need attention?", "What could help the month go better?"]),
    ...
    18: {
        ...
        "prompts": [
            ...
            prompt("An old repeat", "昔繰り返した曲", "Why can an old favourite become hard to listen to?", "昔好きだった曲が聴きにくくなるのは、なぜですか？", ["Can time make it enjoyable again?", "What usually makes someone tire of a song?"]),
    ...
    19: {
        ...
        "prompts": [
            prompt("Still not done", "まだしていないこと", "Which kind of task are you most likely to put off?", "あなたはどんな課題を、いちばん先延ばしにしやすいですか？", ["What makes it easy for you to delay?", "When does it become urgent?"]),
            ...
            prompt("A past delay", "以前の先延ばし", "What could finally make you start a task you had put off?", "先延ばしにしていた課題を、あなたがついに始めるきっかけは何ですか？", ["Which pressure or reward could help you?", "What might end a long delay?"]),
    ...
    20: {
        ...
        "prompts": [
            prompt("A bag today", "今日のかばん", "Which everyday item would be most inconvenient to forget?", "日常の持ち物で、忘れるといちばん困る物は何ですか？", ["What need does it meet?", "How easy would it be to replace?"]),
            prompt("What you carry", "持ち歩く物", "What would you carry for an ordinary day out?", "ふつうの外出なら、あなたは何を持っていきますか？", ["Which item would go in a bag rather than a pocket?", "What could stay at home?"]),
            prompt("What's inside", "入っている物", "What tends to take up the most space in your bag or pockets?", "かばんやポケットの中で、何がいちばん場所を取りやすいですか？", ["Which category takes the most space?", "What do you carry without using very often?"], full_followups=["Which category takes the most space?", "What do you carry without using very often?"]),
            ...
            prompt("There for months", "何か月もある物", "Which item are you most likely to carry for months without using?", "何か月も使わないまま持ち歩きそうな物は何ですか？", ["Why might it stay there so long?", "What would finally make you remove it?"]),
            ...
            prompt("How it changed", "変わった持ち物", "How have phones changed what people carry?", "スマートフォンによって、人の持ち物はどう変わりましたか？", ["Which item has become less necessary?", "What new item has become common?"], full_followups=["Which item has become less necessary?", "Which new item has become common?"]),
