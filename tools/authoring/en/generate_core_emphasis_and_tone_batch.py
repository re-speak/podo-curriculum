...
SPECS = {
    ...
    104: semantic_spec(
        ...
        (("Contrast two factors and name the deciding one.", "二つの要素を対比し、決め手を言いましょう。"), ("Identify who did one action.", "一つの行動をした人を特定しましょう。")),
    ...
    105: semantic_spec(
        ...
        (("Explain one way waiting makes a task harder.", "待つことで作業が難しくなる点を一つ説明しましょう。"), ("Explain one way starting sooner helps.", "早く始めることの利点を一つ説明しましょう。")),
    ...
    108: semantic_spec(
        ...
        (("Make a careful request to a less familiar person.", "あまり親しくない相手に丁寧な依頼をしましょう。"), ("Make an informal request to a close colleague.", "親しい同僚にくだけた依頼をしましょう。")),
...
FREE_TALK = {
    ...
    112: (
        ...
        "メッセージでは、短い・直接的・曖昧な口調のうち、どれがいちばん誤解しやすいですか？なぜですか？",
        "What about you—which tone is easiest to misunderstand?",
        "先生はどうですか？どの口調がいちばん誤解しやすいですか？",
    ),
}
