#!/usr/bin/env python3
"""Run the CTX49-60 Orca layout probe with every activity visibly filled."""
...
COURSES = (
    ROOT / "sandbox/drafts/en/tracks/2-contextual-english/courses/ctx-business-negotiation-diplomacy",
    ROOT / "sandbox/drafts/en/tracks/2-contextual-english/courses/ctx-business-leadership-high-stakes",
)
