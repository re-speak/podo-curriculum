...
TOPICS = {
    ...
    22: topic(
        ...
        prompts=[
            prompt("The first enjoyable thing", "最初に楽しめたもの", "What kind of English content would feel enjoyable to you instead of like study?", "どんな英語のコンテンツなら、勉強ではなく楽しみだと感じられそうですか？", ["Which format comes to mind first?", "What would make it personally interesting?"]),
            prompt("The kind of thing", "どんなもの？", "Which format makes English easiest for you to enjoy: watching, listening, reading, or playing?", "見る、聴く、読む、遊ぶの中で、あなたがいちばん英語を楽しみやすい形式はどれですか？", ["What does that format add for you?", "Could another person make the experience more enjoyable?"]),
            prompt("Your age then", "そのときの年齢", "At what age can English entertainment first become memorable?", "英語のエンターテインメントが記憶に残り始めるのは、何歳くらいだと思いますか？", ["Which interests matter at that age?", "How might English fit into life then?"]),
            prompt("How much you understood", "理解できた量", "How much English would you need to understand before you could enjoy the content?", "コンテンツを楽しむには、英語をどのくらい理解できればよいですか？", ["Which part would need to be clear first?", "What could support the difficult parts?"]),
            prompt("What came next", "その次", "What would you try next after enjoying one thing in English?", "英語で一つ楽しめたあと、次に何を試したいですか？", ["How would you find something similar?", "Which action could keep your interest going?"]),
            prompt("What brought you here", "今につながったもの", "How could enjoyable English content influence the English you use later?", "楽しい英語のコンテンツは、その後にあなたが使う英語にどう影響しそうですか？", ["Which connection might be strongest for you?", "What could change because of it?"]),
            prompt("A good starting point", "よい入り口", "What would help you enjoy English before you understood everything?", "すべて理解できる前でも、あなたが英語を楽しむには何が役立ちそうですか？", ["How much support would be useful?", "What could make the experience feel like work?"]),
    ...
    23: topic(
        ...
        prompts=[
            ...
            prompt("Five years ago", "5年前の好み", "What kind of music from five years ago still feels connected to that time?", "5年前のどんな音楽が、今もその時期と結びついて感じられますか？", ["Why does that sound fit the time?", "Which old favourite could still work now?"]),
    ...
    28: topic(
        ...
        prompts=[
            ...
            prompt("The book", "その本", "What is the book you chose about?", "選んだ本は、どんな内容ですか？", ["Which detail stays with a reader?", "Which part might interest the other person most?"]),
