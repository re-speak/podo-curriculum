...
LESSONS = {
    ...
    31: dict(
        ...
        p2=pattern(bridge="次に、普段いちばん連携する相手を伝えます。", meaning=("Use this to identify the team you collaborate with most often.", "最も頻繁に連携するチームを示す表現です。"), rows_=rows(("{t}I mainly work with{/t} the design team.", "主にデザインチームと{t}一緒に働いています{/t}。", "I mainly work with|the design team|on this project."), ("{t}I mainly work with{/t} the sales and finance teams.", "主に営業チームと財務チームと{t}一緒に働いています{/t}。", "I mainly work with|the sales and finance teams|on this project."), ("{t}I mainly work with{/t} two teams in Osaka.", "主に大阪の二つのチームと{t}一緒に働いています{/t}。", "I mainly work with|two teams in Osaka|on this project."), ("{t}I mainly work with{/t} the engineering team.", "主にエンジニアリングチームと{t}一緒に働いています{/t}。", "I mainly work with|the engineering team|on this project.")), rule=("Put the collaborator after “with”", "連携相手は with のあと", "Use a team or group of people after the intact frame.", "ひとまとまりの表現のあとに、チームや人の集団を続けます。", "I mainly work with + team", "Name the collaboration", "連携相手を示す", ("work with · the design team", "work with · the sales team")), write=("Which team do you work with most often?", "どのチームと最もよく連携しますか？")),
...
REVIEWED_COPY_25_36 = {
    ...
    31: dict(
        ...
        p2=dict(write_frame="I mainly work with ___", write_script="Use “I mainly work with ___” to name your main partner team.", write_script_ja="「I mainly work with ___」を使って、主に連携するチームを伝えましょう。", translate_hints=(("デザインチーム", "the design team"), ("営業チームと財務チーム", "the sales and finance teams"), ("大阪の二つのチーム", "two teams in Osaka"), ("エンジニアリングチーム", "the engineering team"))),
    ),
    32: dict(
