...
LESSONS = {
    7: dict(
        ...
        vocab=(
            "check-in time|チェックイン時間; luggage room|荷物預かり室; receipt|お預かり証",
            "reservation|予約|CORE-5; can we leave|置いてもいいですか|CORE-21",
            "hotel|ホテル; bag|バッグ; suitcase|スーツケース; backpack|リュック; stroller|ベビーカー; room|部屋",
    ...
    8: dict(
        ...
        vocab=(
            "air conditioning|エアコン; malfunction|故障; remedy|対応",
            "doesn't work|動かない|CORE-14; can we|できますか|CORE-21",
            "hotel|ホテル; room|部屋; shower|シャワー; key card|キーカード; bedside lamp|ベッド脇のランプ; fan|扇風機",
    ...
    9: dict(
        ...
        vocab=(
            "allergic|アレルギーがある; shellfish|甲殻類; dairy|乳製品; nut-free|ナッツ不使用",
            "contain|含む|CORE-13; I don't eat|食べません|CORE-14",
            "restaurant|レストラン; nuts|ナッツ; fish|魚; sauce|ソース; eggs|卵",
    ...
    10: dict(
        ...
        vocab=(
            "iced coffee|アイスコーヒー; sparkling water|炭酸水; still water|普通の水; mix-up|取り違え",
            "ordered|注文した|CORE-32; can I have|いただけますか|CORE-22; instead|代わりに|CORE-14",
            "coffee|コーヒー; tea|紅茶; soup|スープ; salad|サラダ",
    ...
    11: dict(
        ...
        vocab=(
            "travel adapter|旅行用アダプター; proof of purchase|購入証明; refund|返金; replacement|交換品",
            "bought|買った|CORE-32; doesn't work|動かない|CORE-14; exchange|交換する|CORE-21",
    ...
    12: dict(
        ...
        vocab=(
            ...
            "can we move|変更できますか|CORE-21; still|今も|CORE-8; reservation|予約|CORE-5",
            "restaurant|レストラン; people|人; Friday|金曜日; Saturday|土曜日; tour|ツアー",
