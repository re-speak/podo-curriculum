...
VOCAB = {
    71: dict(new="sooner|もっと早く; cancel|取り消す", recycled="earlier|さっき・より早く|CORE-55; book|予約する|CORE-41; yesterday|昨日|CORE-30", assumed="call|電話する; check|確認する; leave|出発する; tell|伝える; say|言う; wait|待つ; send|送る; message|メッセージ", receptive="regret|後悔する; my bad|私のミス; lesson learned|勉強になった; none comes to mind|思いつかない"),
    72: dict(new="traffic|交通・渋滞; locked|鍵がかかった", recycled="somewhere else|別の場所|CORE-39; bag|かばん|CORE-5; key|鍵|CORE-5; tired|疲れた|CORE-30", assumed="home|家; train|電車; door|ドア; miss|乗り遅れる; put|入れる; bad|ひどい; this morning|今朝; after work|仕事のあと", receptive="conclusion|結論; come to think of it|そういえば; that would explain it|それなら説明がつく; evidence|根拠; mystery|気になる出来事"),
    ...
    77: dict(new="delivery|配達", recycled="update|進捗・最新情報|CORE-37; repair|修理する|CORE-76; noon|正午|CORE-38; Friday|金曜日|CORE-28", assumed="ready|準備できた; order|注文; check|確認する; arrive|到着する; finish|終える; today|今日", receptive="agreed expectation|合意上の予定; Do you have an update?|進捗はありますか？; When can I expect it?|いつ受け取れますか？; take a look|見てみる"),
    78: dict(new="", recycled="traveling|移動中|CORE-27; client|顧客|CORE-54; noon|正午|CORE-38; drive|運転する|CORE-14; meet|会う|CORE-29", assumed="wait|待つ; work|働く; fly|飛ぶ; home|家; stay|滞在する; Osaka|大阪; lunch|昼食; tomorrow|明日; next week|来週", receptive="future point|未来の時点; all being well|順調なら; fingers crossed|うまくいきますように; firm arrangement|確定した予定"),
