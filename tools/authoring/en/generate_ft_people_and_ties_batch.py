...
50: topic(
 ...
 prompts=[
  ...
  prompt("Why it feels bold", "大胆に感じる理由", "What makes a solo activity feel bold?", "一人での活動が大胆に感じられるのはなぜですか？", ["How much do other people's reactions matter?", "Which practical difficulty matters most?"], full="What makes one solo activity feel significantly bolder than another?", full_ja="一人での活動の中でも、特に大胆に感じるものがあるのはなぜですか？", full_followups=["How strongly do social expectations shape the feeling?", "Which practical obstacle carries the most weight?"]),
